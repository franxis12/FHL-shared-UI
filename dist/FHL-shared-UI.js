...
function Zt({ number: e, className: n = "" }) {
	return /* @__PURE__ */ t("span", {
		className: n,
		children: e
	});
}
function Qt({ checklist: e }) {
	return /* @__PURE__ */ t("div", {
		className: "overflow-x-auto pb-1 pt-4",
		children: /* @__PURE__ */ t("ol", {
			className: "flex min-w-[44rem] items-start",
			"aria-label": "Progress steps",
			children: e.map((r, i) => {
				let a = Yt(e, i), o = i > 0 && a !== "upcoming", s = !!(r.href || r.onClick);
				return /* @__PURE__ */ n("li", {
					...
					children: [
						...
						/* @__PURE__ */ t("div", {
							className: `relative z-10 rounded-full ${a === "current" ? "ring-4 ring-[var(--fhl-color-selected-soft)]" : ""}`,
							children: /* @__PURE__ */ t(k, {
								href: s ? r.href : void 0,
								onClick: s ? r.onClick : void 0,
								disabled: !s,
								variant: Xt(a),
								size: x.SM,
								shape: S.CIRCLE,
								icon: (e) => /* @__PURE__ */ t(Zt, {
									...e,
									number: i + 1
								}),
...
function $t({ title: e = "Progress", description: n = "", summary: r = "", checklist: i = [] }) {
	return /* @__PURE__ */ t(se, {
		title: e,
		description: n,
		footer: r ? /* @__PURE__ */ t(y, {
			as: "p",
			size: d.SM,
			tone: p.MUTED,
			children: r
		...
		radius: V.XL,
		surface: B.DEFAULT,
		children: /* @__PURE__ */ t(Qt, { checklist: i })
	});
}
//#endregion
//#region src/components/DashboardNavbar/DashboardNavbar.jsx
var en = "hidden min-h-0 flex-col md:!flex md:h-full md:border-b-0", Y = "duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]";
function tn(e) {
	return /* @__PURE__ */ t("svg", {
		viewBox: "0 0 24 24",
		fill: "none",
...
function un({ isOpen: e, title: r, message: i, confirmLabel: o, cancelLabel: s, isConfirming: c = !1, onCancel: l, onConfirm: u }) {
	return a(() => {
		if (!e) return;
		function t(e) {
			e.key === "Escape" && l?.();
		...
		children: /* @__PURE__ */ n("div", {
			...
			children: [/* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ n("div", {
					...
					children: /* @__PURE__ */ t(nn, { className: "h-5 w-5" })
				})]
			}), /* @__PURE__ */ n("div", {
...
function fn({ item: r, collapsed: i = !1 }) {
	...
	return /* @__PURE__ */ n("div", {
		...
		children: [r.href ? /* @__PURE__ */ t("a", {
			...
			children: r.children.map((e, n) => /* @__PURE__ */ t(dn, { item: e }, rn(e, n)))
		}) : null]
	});
}
function pn({ item: r, collapsed: i = !1 }) {
	let a = r.icon, o = on(i), s = sn(i), c = /* @__PURE__ */ n(e, { children: [a ? /* @__PURE__ */ t(a, {
		className: "h-5 w-5 shrink-0",
		"aria-hidden": "true",
		focusable: "false"
	}) : null, /* @__PURE__ */ t("span", {
...
function mn({ brand: r, navItems: i = [], navSections: o = [], footerItems: s = [], className: l = "", style: d, collapsed: f = !1, collapseToggle: p, isSigningOut: m = !1, onSignOut: h, signOutIcon: g, signOutLabel: _ = "Log out", signingOutLabel: v = "Signing out...", supportItem: y, supportLabel: b = "Call support", supportHref: x = "tel:+13055550199", supportIcon: S = tn, requireSignOutConfirmation: C = !0, signOutConfirmationTitle: w = "Sign out?", signOutConfirmationMessage: T = "You will need to sign in again to access this dashboard.", signOutConfirmationLabel: E = "Sign out", signOutCancelLabel: D = "Cancel", mobileDrawer: O = !1, mobileOpen: k = !1, onMobileClose: A, mobileWidthClassName: j = "!w-[50vw] max-w-[50vw]", mobileCloseLabel: M = "Close menu", mobileCloseIcon: N = nn }) {
	let [P, F] = u(!1), [I, ee] = u(ln), L = O && k && !I, R = L ? !1 : f, te = O ? [
		en,
		L ? "!fixed inset-y-0 left-0 z-[70] !flex h-[100dvh]" : "",
		"md:!relative md:inset-auto md:z-auto md:!flex md:h-full md:border-b-0",
		l,
		L ? j : ""
	].filter(Boolean).join(" ").trim() : `${en} ${l}`.trim(), z = cn(r), B = c(() => {
				...
				V ? /* @__PURE__ */ n("div", {
					...
					children: [
						...
						h ? /* @__PURE__ */ n("button", {
							...
							onClick: re,
							disabled: m,
							className: `flex w-full items-center rounded-xl py-2 text-left text-sm font-semibold transition-[background-color,color] hover:bg-[var(--fhl-navbar-hover-bg)] disabled:opacity-60 ${Y} ${sn(R)}`,
							style: { color: "var(--fhl-navbar-text-muted)" },
							"aria-label": m ? v : _,
							title: R ? _ : void 0,
...
function yn({ breadcrumbItems: e = [], actions: r = [], className: i = "", style: a }) {
	return /* @__PURE__ */ t("section", {
		...
		children: /* @__PURE__ */ n("div", {
			...
			children: [/* @__PURE__ */ t(Lt, { items: e }), r.length > 0 ? /* @__PURE__ */ t("div", {
				...
				children: r.map((e, n) => /* @__PURE__ */ t(vn, { action: e }, hn(e, n)))
			}) : null]
		})
	});
}
...
function Cn({ dashboardLabel: e = "Dashboard", currentTabLabel: r = "Overview", currentTabHint: i = "", displayName: o = "User", userLabel: s = "Logged user", topbarBadges: c = [], avatarContent: l, mobileMenuButton: d, className: f = "", style: p }) {
	let [m, h] = u(Sn), g = String(o || "User").trim() || "User", _ = l ?? g.charAt(0).toUpperCase(), v = `px-4 py-3 md:px-5 ${f}`.trim(), y = d?.icon ?? xn, b = d?.label ?? "Open menu";
	return a(() => {
		if (typeof window > "u" || typeof window.matchMedia != "function") return;
		let e = window.matchMedia("(min-width: 768px)"), t = (e) => {
			h(e.matches);
...
function kn({ columns: e = [], rows: r = [], rowKey: i = "id", selectedRowKey: a, onRowClick: o, emptyMessage: s = "No records available.", className: c = "", tableClassName: l = "" }) {
	let u = Array.isArray(r) && r.length > 0;
	return /* @__PURE__ */ t("div", {
		className: wn("overflow-hidden rounded-2xl border bg-[var(--fhl-color-surface)] shadow-[0_18px_40px_-30px_var(--fhl-color-shadow)]", c),
		style: { borderColor: "var(--fhl-color-border)" },
		children: /* @__PURE__ */ t("div", {
			className: "overflow-x-auto",
			children: /* @__PURE__ */ n("table", {
				className: wn("min-w-full border-collapse", l),
				children: [/* @__PURE__ */ t("thead", {
					className: "bg-[var(--fhl-color-surface-soft)]",
					children: /* @__PURE__ */ t("tr", { children: e.map((e, n) => /* @__PURE__ */ t("th", {
						scope: "col",
						className: wn("px-4 py-3 text-xs font-bold uppercase tracking-[0.14em] text-[var(--fhl-color-text-muted)]", Dn(e.align), e.headerClassName),
						style: e.width ? { width: e.width } : void 0,
						children: e.label
					}, Tn(e, n))) })
				}), /* @__PURE__ */ t("tbody", { children: u ? r.map((n, r) => {
					let s = En(n, r, i), c = a === s, l = typeof o == "function";
					return /* @__PURE__ */ t("tr", {
						className: wn("border-t transition", l ? "cursor-pointer hover:bg-[color-mix(in_srgb,var(--fhl-color-surface)_90%,var(--fhl-color-primary)_10%)]" : "", c ? "bg-[color-mix(in_srgb,var(--fhl-color-surface)_88%,var(--fhl-color-primary)_12%)]" : ""),
						style: { borderColor: "var(--fhl-color-border)" },
						...
						children: e.map((e, r) => /* @__PURE__ */ t("td", {
							className: wn("px-4 py-3 align-top text-sm text-[var(--fhl-color-text)]", Dn(e.align), e.cellClassName),
...
function An({ items: e = [], className: r = "" }) {
...
function Fn({ isOpen: e, position: r, items: i = [], sections: o = [], onClose: d }) {
	let f = l(null), [p, m] = u(jn), h = c(() => {
	...
	s(() => {
		...
		let t = f.current.getBoundingClientRect(), n = t.width || jn.width, r = t.height || jn.height;
	...
	let g = c(() => {
		...
		return {
			left: Mn(r.x, 12, e - p.width - 12),
			top: Mn(r.y, 12, t - p.height - 12)
		};
	}, [
		p.height,
		p.width,
...
function Bn({ imageUrl: e = "", imageAlt: r = "", imageFallbackLabel: i = "No image", eyebrow: a = "", title: o, subtitle: s = "", description: c = "", meta: l = [], badges: u = [], onClick: d, onContextMenu: f, onActionsClick: p, actionsLabel: m = "Actions", actionIcon: h, className: g = "" }) {
	return /* @__PURE__ */ t("article", {
		className: In("group min-w-0 rounded-xl border p-3.5 transition md:p-4", "hover:border-[var(--fhl-color-primary)] hover:bg-[color-mix(in_srgb,var(--fhl-color-surface)_92%,var(--fhl-color-primary)_8%)]", g),
		style: {
			borderColor: "var(--fhl-color-border)",
			backgroundColor: "var(--fhl-color-surface)",
...
function rr({ isFavorite: e = !1, isSaving: r = !1, onToggle: i, variant: a = "floating", className: o = "", label: s, title: c }) {
	...
	return /* @__PURE__ */ n("button", {
		...
		"aria-label": u,
		title: c || u,
		children: [e ? /* @__PURE__ */ t(Vn, { className: l ? "h-5 w-5" : "h-7 w-7" }) : /* @__PURE__ */ t($n, { className: l ? "h-5 w-5 stroke-[2.2]" : "h-7 w-7 stroke-[2.2]" }), l ? /* @__PURE__ */ t("span", { children: e ? "Saved" : "Save" }) : null]
	});
}
//#endregion
...
var lr = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, selected: c = !1, files: u = [], accept: m = "", multiple: h = !1, required: g = !1, disabled: _ = !1, buttonLabel: v = "", emptyTitle: S = "", emptyDescription: C = "", onFilesSelect: w, onRemoveFile: T, className: E = "", dropzoneClassName: D = "", fileListClassName: O = "" }, A) {
	let j = o(), M = e ?? `fhl-file-uploader-${j}`, N = l(null), P = cr(u), F = P.length > 0, I = sr(a, c || F), ee = {
	...
	return /* @__PURE__ */ n("div", {
		className: or("w-full space-y-3", E),
		children: [
			r ? /* @__PURE__ */ n(y, {
				as: "label",
				htmlFor: M,
			...
			/* @__PURE__ */ n("div", {
				className: or("rounded-[28px] border border-dashed bg-[var(--fhl-container-bg-soft)] p-4 transition", "border-[var(--fhl-file-uploader-current-border)] focus-within:ring-4", _ ? "opacity-60" : "", D),
				style: ee,
				children: [/* @__PURE__ */ n("div", {
					...
					className: or("mt-4 space-y-2 border-t border-[var(--fhl-container-border)] pt-4", O),
					children: P.map((e, r) => {
...
var hr = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, icon: c, selected: l = !1, className: u = "", containerClassName: m = "", selectClassName: h = "", labelClassName: g = "", helperClassName: _ = "", statusClassName: v = "", disabled: b = !1, required: x = !1, children: S, "aria-describedby": C, "aria-invalid": w, ...T }, E) {
	let D = o(), O = e ?? `fhl-select-${D}`, k = i ? `${O}-helper` : void 0, A = s ? `${O}-status` : void 0, j = pr(C, k, A), M = w ?? (a === W.ERROR ? !0 : void 0), N = mr(a, l), P = {
	...
	return /* @__PURE__ */ n("div", {
		className: fr("w-full space-y-1.5", u),
		children: [
			r ? /* @__PURE__ */ n(y, {
				as: "label",
				htmlFor: O,
				size: d.SM,
				weight: f.SEMIBOLD,
				className: fr("block text-[var(--fhl-input-label)]", g),
			...
			/* @__PURE__ */ n("div", {
				...
				children: [
					...
					/* @__PURE__ */ t("select", {
						...
						"aria-describedby": j,
						"aria-invalid": M,
						className: fr("min-w-0 flex-1 appearance-none bg-transparent text-[length:var(--fhl-text-size-sm)] leading-[var(--fhl-text-leading-sm)] font-medium text-[var(--fhl-input-text)] outline-none", "disabled:cursor-not-allowed disabled:text-[var(--fhl-input-disabled-text)]", h),
						children: S
					}),
					/* @__PURE__ */ t(We, {
			...
			i ? /* @__PURE__ */ t(y, {
				...
				weight: f.MEDIUM,
				tone: p.MUTED,
				className: fr("text-[var(--fhl-input-helper)]", _),
				children: i
			}) : null,
			s ? /* @__PURE__ */ t(y, {
				as: "p",
...
var X = "flex flex-col gap-1.5", Z = "text-xs font-semibold tracking-wide uppercase text-[var(--fhl-color-text-muted)]", Q = "min-h-10 rounded-xl border-[var(--fhl-color-border)] px-3 py-2 shadow-none", $ = "text-sm", vr = "h-8 px-3 shadow-none transition-colors duration-200";
function yr({ filters: e, propertyTypeOptions: r = [], onFilterChange: i, onClearFilters: o }) {
			...
			children: [/* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ n("div", {
					...
					children: [/* @__PURE__ */ t(k, {
						...
						size: x.SM,
						shape: S.PILL,
						className: `${vr} inline-flex border-transparent bg-(--fhl-color-hover-soft) text-(--fhl-color-text) hover:bg-(--fhl-color-selected-soft)`,
					...
					size: x.SM,
					shape: S.PILL,
					className: `${vr} border-transparent bg-(--fhl-color-accent)  text-(--fhl-color-accent-contrast) hover:bg-(--fhl-color-accent) hover:brightness-95`,
					children: "Clear"
				})]
			}), /* @__PURE__ */ t("div", {
				...
				children: /* @__PURE__ */ n("div", {
					...
					children: [
						...
						/* @__PURE__ */ t(hr, {
							...
							containerClassName: Q,
							selectClassName: $,
							children: gr.map((e) => /* @__PURE__ */ t("option", {
								value: e.value,
								children: e.label
							}, e.value))
						}),
...
var br = "image/webp,image/jpeg,image/png";
function xr(e) {
	if (!e) return "";
	let t = e / (1024 * 1024);
	return `${Number.isInteger(t) ? t : t.toFixed(1)}MB`;
}
function Sr(e, { accept: t, maxSizeBytes: n }) {
	let r = t ? t.split(",").map((e) => e.trim()) : null;
	return r && r.length > 0 && !r.includes(e.type) ? "Use a valid image format." : n && e.size > n ? `Each image must be ${xr(n)} or less.` : null;
}
function Cr(e, t) {
	return [
		e?.name,
...
function Er(e, t) {
	if (!e) return null;
	if (wr(e)) return typeof URL > "u" || typeof URL.createObjectURL != "function" ? null : {
		key: Cr(e, t),
		label: Tr(e, t),
...
function Dr({ disabled: e, multiple: r, onClick: i }) {
	return /* @__PURE__ */ n("button", {
		type: "button",
		onClick: i,
		disabled: e,
		...
		children: [
			/* @__PURE__ */ n("span", {
				...
				children: [/* @__PURE__ */ t(Jn, { className: "h-6 w-6 opacity-80" }), /* @__PURE__ */ t("span", {
					...
					children: /* @__PURE__ */ t(qn, { className: "h-4 w-4" })
				})]
			}),
			/* @__PURE__ */ t("span", {
...
function Or({ preview: e, label: r, removable: i = !0, onOpenPicker: a, onRemove: o }) {
	return /* @__PURE__ */ n("div", {
		...
		children: [/* @__PURE__ */ n(a ? "button" : "div", {
			...
			"aria-label": `Remove ${r}`,
			children: /* @__PURE__ */ t(Wn, { className: "h-4.5 w-4.5" })
		}) : null]
	});
}
function kr({ label: e, helperText: r, multiple: i = !1, maxFiles: s, accept: c = br, maxSizeBytes: d, value: f, onChange: p, onError: m, required: h = !1 }) {
	let g = o(), _ = l(null), [v, y] = u([]), b = i ? Array.isArray(f) ? f : [] : f ? [f] : [], x = !!(i && s && b.length >= s);
	a(() => {
		let e = (i ? Array.isArray(f) ? f : [] : f ? [f] : []).map((e, t) => Er(e, t)).filter(Boolean);
		return y(e), () => {
			e.forEach((e) => {
	...
	return /* @__PURE__ */ n("div", {
		...
		children: [
			...
			/* @__PURE__ */ n("div", {
				...
				}), i ? x ? null : /* @__PURE__ */ t(Dr, {
					disabled: !1,
					multiple: !0,
					onClick: S
				}) : b.length > 0 ? null : /* @__PURE__ */ t(Dr, {
					disabled: !1,
					multiple: !1,
					onClick: S
				})]
...
function Ar({ label: e, value: r, hint: i, icon: a }) {
	return /* @__PURE__ */ n("article", {
...
function Fr({ isOpen: r, title: i = "Photos", images: o = [], initialIndex: s = 0, onClose: l }) {
	let [d, f] = u(() => Pr(o, s));
	a(() => {
		r && f(Pr(o, s));
	}, [
			...
			children: [
				/* @__PURE__ */ n("div", {
					...
					children: [/* @__PURE__ */ n("div", { children: [/* @__PURE__ */ t("p", {
						...
						children: /* @__PURE__ */ t(jr, { className: "h-5 w-5" })
					})]
				}),
				/* @__PURE__ */ n("div", {
...
function Ir({ label: e = "No photos available" }) {
	return /* @__PURE__ */ t("div", {
...
function Ur({ title: e, propertyType: r, address: i, coverImageUrl: a, coverImageAlt: o, onOpen: s, onEdit: c, editIcon: l, editLabel: u = "Edit property", imageFallbackLabel: m = "No cover image", availableUnitsLabel: h, occupancyLabel: g, occupancyTone: _ = Rr.DEFAULT, ratingValue: v = null, ratingCount: b = 0, className: x = "" }) {
	let S = Number.isFinite(Number(v)) && Number(b) > 0, C = zr[_] ?? zr[Rr.DEFAULT], w = b === 1 ? "1 review" : `${b} reviews`;
	return /* @__PURE__ */ n("article", {
		className: Br("group relative overflow-hidden rounded-2xl border transition duration-200 hover:-translate-y-1 hover:shadow-[0_22px_40px_-26px_var(--fhl-color-shadow)]", x),
		style: {
			borderColor: "var(--fhl-color-border)",
			backgroundColor: "var(--fhl-color-surface)",
		...
		children: [/* @__PURE__ */ n("button", {
			...
			children: [/* @__PURE__ */ n("div", {
				...
				}) : /* @__PURE__ */ t(Hr, { label: m }), /* @__PURE__ */ t("div", { className: "pointer-events-none absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-black/55 via-black/10 to-transparent" })]
			}), /* @__PURE__ */ n("div", {
					...
					/* @__PURE__ */ n("div", {
						...
						children: [/* @__PURE__ */ n("div", {
							...
							children: [/* @__PURE__ */ t(y, {
								...
								children: [/* @__PURE__ */ t(Vr, { className: "h-4 w-4 text-[var(--fhl-color-primary)]" }), S ? /* @__PURE__ */ t(y, {
									as: "p",
									size: d.SM,
		...
		children: /* @__PURE__ */ n("div", {
			...
			children: [/* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ n("div", {
					...
					children: /* @__PURE__ */ t(Wr, { className: "h-5 w-5" })
				})]
			}), /* @__PURE__ */ n("form", {
...
function Xr({ icon: e, value: r, label: i, size: a = Kr.MD, align: o = "center", className: s = "" }) {
	return /* @__PURE__ */ n("div", {
		className: Yr("flex items-center gap-3 px-2", o === "center" ? "justify-center" : "justify-start", s),
		children: [e ? /* @__PURE__ */ t(e, {
			className: Yr(qr[a] ?? qr.md, "shrink-0 text-[var(--fhl-color-primary)]"),
			"aria-hidden": "true",
			focusable: "false"
		}) : null, /* @__PURE__ */ n("div", {
			className: "text-left",
...
function Qr({ items: e = [], activeKey: n, onSelect: r, className: i = "" }) {
	return /* @__PURE__ */ t("nav", {
		className: Zr("flex gap-8 overflow-x-auto border-b text-sm font-semibold text-[var(--fhl-color-text-muted)]", i),
		style: { borderColor: "var(--fhl-color-border)" },
		children: e.map((e) => {
			let i = e.key === n;
			return /* @__PURE__ */ t("a", {
				href: e.href,
				onClick: (t) => r?.(e.key, t),
				className: Zr("shrink-0 border-b-2 px-1 py-4 transition hover:text-[var(--fhl-color-accent)]", i ? "border-[var(--fhl-color-accent)] text-[var(--fhl-color-accent)]" : "border-transparent"),
				children: e.label
			}, e.key);
		})
	});
...
var ii = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, icon: c, selected: l = !1, className: u = "", containerClassName: m = "", textareaClassName: h = "", labelClassName: g = "", helperClassName: _ = "", statusClassName: v = "", disabled: b = !1, required: x = !1, rows: S = 4, resize: C = "vertical", "aria-describedby": w, "aria-invalid": T, ...E }, D) {
	let O = o(), k = e ?? `fhl-textarea-${O}`, A = i ? `${k}-helper` : void 0, j = s ? `${k}-status` : void 0, M = ni(w, A, j), N = T ?? (a === W.ERROR ? !0 : void 0), P = ri(a, l), F = {
	...
	return /* @__PURE__ */ n("div", {
		className: ti("w-full space-y-1.5", u),
		children: [
			r ? /* @__PURE__ */ n(y, {
				as: "label",
				htmlFor: k,
				size: d.SM,
				weight: f.SEMIBOLD,
				className: ti("block text-[var(--fhl-input-label)]", g),
				children: [r, x ? /* @__PURE__ */ t("span", {
					className: "ml-1 text-[var(--fhl-color-primary)]",
					children: "*"
				}) : null]
			...
			/* @__PURE__ */ n("div", {
				className: ti("flex gap-3 rounded-2xl border px-3.5 py-3 shadow-sm transition", "border-[var(--fhl-textarea-current-border)] bg-[var(--fhl-textarea-current-bg)]", "focus-within:border-[var(--fhl-textarea-current-border)]", "focus-within:ring-4 focus-within:ring-[var(--fhl-textarea-current-ring)]", b ? "cursor-not-allowed" : "", m),
				style: F,
			...
			i ? /* @__PURE__ */ t(y, {
				...
				weight: f.MEDIUM,
				tone: p.MUTED,
				className: ti("text-[var(--fhl-input-helper)]", _),
				children: i
			}) : null,
			s ? /* @__PURE__ */ t(y, {
				as: "p",
...
function ci(e) {
	return e === ai.DARK ? Fe : e === ai.LIGHT ? Me : Ie;
}
function li(e) {
	return e === "navy" ? {
...
function ui({ value: e = ai.SYSTEM, onChange: r, options: i = oi, compact: a = !1, tone: o = "surface", className: s = "", ariaLabel: c = "Theme mode", disabled: l = !1 }) {
	return /* @__PURE__ */ t("div", {
		role: "radiogroup",
		"aria-label": c,
		className: si("inline-flex items-center rounded-full border transition", a ? "gap-1 px-1.5 py-2" : "gap-1 px-1.5 py-1.5", s),
		style: li(o),
		children: i.map((i) => {
			let o = e === i.mode, s = ci(i.mode);
			return /* @__PURE__ */ n("button", {
				type: "button",
				role: "radio",
				"aria-checked": o,
				...
				disabled: l,
				onClick: () => r?.(i.mode),
				className: si("inline-flex items-center justify-center rounded-full transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--fhl-color-accent-hover) focus-visible:ring-offset-2 focus-visible:ring-offset-(--fhl-color-bg) disabled:cursor-not-allowed disabled:opacity-60", a ? "h-7 w-7" : "gap-1.5 px-2.5 py-1.5", o ? "bg-(--fhl-color-accent) text-(--fhl-color-accent-contrast)" : "text-(--fhl-color-text-muted) hover:bg-(--fhl-color-hover-soft) hover:text-(--fhl-color-text)"),
				children: [/* @__PURE__ */ t(s, {
					"aria-hidden": "true",
					className: si(a ? "h-3.5 w-3.5" : "h-4 w-4", o ? "opacity-100" : "opacity-80")
				}), a ? null : /* @__PURE__ */ t(y, {
					as: "span",
					size: d.XS,
					weight: f.SEMIBOLD,
...
}), fi = new Intl.NumberFormat("en-US", { maximumFractionDigits: 0 });
function pi(e) {
	if (e == null || e === "") return "—";
	let t = Number(e);
	return Number.isFinite(t) ? fi.format(t) : "—";
}
function mi(e) {
	let t = String(e || "").trim();
...
function gi(e) {
	...
	return [[t, n].filter(Boolean).join(", "), r].filter(Boolean).join(" ") || hi(e);
}
function _i({ listing: e, onNavigate: r, isFavorite: i = !1, isFavoriteSaving: a = !1, onToggleFavorite: o }) {
	let s = Number(e.rentAmount), c = Number.isFinite(s), l = mi(e.property.propertyType), u = Number(e.parkingSpaces), m = Number.isFinite(u) && u > 0;
	return /* @__PURE__ */ n("article", {
				...
				children: [
					...
					/* @__PURE__ */ n("div", {
						...
						children: [/* @__PURE__ */ n("div", {
							...
							children: [c ? di.format(s) : "Price", /* @__PURE__ */ t(y, {
								as: "span",
								size: d.XS,
								tone: p.MUTED,
								weight: f.SEMIBOLD,
					...
					/* @__PURE__ */ n("div", {
						...
						children: [
							/* @__PURE__ */ n("div", {
								...
								children: [/* @__PURE__ */ t(Qn, { className: "h-5 w-5 text-[var(--fhl-color-primary)]" }), /* @__PURE__ */ n("div", {
									className: "text-left",
									children: [/* @__PURE__ */ t(y, {
										as: "p",
										size: d.SM,
										weight: f.BOLD,
										children: pi(e.bedrooms)
									}), /* @__PURE__ */ t(y, {
										as: "p",
										size: d.XS,
										tone: p.MUTED,
							...
							/* @__PURE__ */ n("div", {
								className: "flex items-center justify-center gap-2 px-1",
								children: [/* @__PURE__ */ t(er, { className: "h-5 w-5 text-[var(--fhl-color-primary)]" }), /* @__PURE__ */ n("div", {
									className: "text-left",
									children: [/* @__PURE__ */ t(y, {
										as: "p",
										size: d.SM,
										weight: f.BOLD,
										children: pi(e.bathrooms)
									}), /* @__PURE__ */ t(y, {
										as: "p",
										size: d.XS,
										tone: p.MUTED,
					...
					/* @__PURE__ */ n("div", {
						...
						children: [
							/* @__PURE__ */ n(y, {
								...
								children: [/* @__PURE__ */ t(Gn, { className: "h-3.5 w-3.5 text-[var(--fhl-color-primary)]" }), m ? `${pi(e.parkingSpaces)} parking` : "No parking"]
							}),
							/* @__PURE__ */ n(y, {
								as: "span",
								size: d.XS,
								...
								className: "inline-flex items-center gap-1.5 rounded-full bg-[var(--fhl-color-surface-soft)] px-3 py-1.5 text-[11px]",
								children: [
									/* @__PURE__ */ t(Kn, { className: "h-3.5 w-3.5 text-[var(--fhl-color-primary)]" }),
									"Pets ",
							...
							/* @__PURE__ */ n(y, {
								...
								className: "inline-flex items-center gap-1.5 rounded-full bg-[var(--fhl-color-surface-soft)] px-3 py-1.5 text-[11px]",
								children: [
									/* @__PURE__ */ t(Yn, { className: "h-3.5 w-3.5 text-[var(--fhl-color-primary)]" }),
									"Smoking ",
					...
					/* @__PURE__ */ n(y, {
						...
						children: ["View details", /* @__PURE__ */ t(nr, { className: "h-4 w-4 transition group-hover:translate-x-1" })]
					})
				]
			})]
		}), /* @__PURE__ */ t(rr, {
...
//#endregion
export { q as AUTH_PORTAL_MODE, At as AuthPortalPage, me as AuthRedirectCard, j as BADGE_SIZE, A as BADGE_TONE, S as BUTTON_SHAPE, x as BUTTON_SIZE, b as BUTTON_VARIANT, L as Badge, k as Button, Ke as CHECKBOX_STATUS, z as CONTAINER_PADDING, V as CONTAINER_RADIUS, B as CONTAINER_SURFACE, Rt as Card, Qe as Checkbox, se as Container, zt as DASHBOARD_RECORD_CARD_TONE, Pt as DashboardActivityFeed, Lt as DashboardBreadcrumb, Mt as DashboardEmptyState, mn as DashboardNavbar, $t as DashboardProgressCard, Wt as DashboardRecordCard, Jt as DashboardRecordList, yn as DashboardRouteBar, Cn as DashboardTopbar, kn as DataTable, An as DefinitionList, Fn as EntityActionMenu, Bn as EntityListItem, ir as FILE_UPLOADER_STATUS, rr as FavoriteButton, lr as FileUploader, yr as HomeFilters, W as INPUT_STATUS, kr as ImageUploader, G as Input, H as LOGO_MODES, fe as Logo, Ar as MetricCard, K as NOTICE_TONE, at as Notice, Rr as PROPERTY_DASHBOARD_CARD_FEEDBACK_TONE, Fr as PhotoCarouselModal, Lr as PhotoGallery, Ur as PropertyDashboardCard, ut as PublicFooter, Ct as PublicNavbar, Gr as QuickEditFieldDialog, ur as SELECT_STATUS, J as SKELETON_RADIUS, Kr as STAT_ITEM_SIZE, hr as Select, qt as Skeleton, Xr as StatItem, $r as TEXTAREA_STATUS, d as TEXT_SIZE, p as TEXT_TONE, f as TEXT_WEIGHT, ai as THEME_TOGGLE_MODE, Qr as Tabs, y as Text, ii as Textarea, ui as ThemeToggle, _i as UnitListingCard };
