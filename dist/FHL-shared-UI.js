...
function Tt(e, t) {
	return t || (e === J.ACCOUNT_CREATED ? "Account Created" : e === J.REGISTER ? "Create Account" : e === J.CHANGE_PASSWORD ? "Change Password" : e === J.FORGOT_PASSWORD ? "Forgot Password" : e === J.RESET_PASSWORD ? "Reset Password" : "Sign In");
}
function Et(e) {
...
function kt({ mode: r = J.LOGIN, title: i = "", notice: a = null, submitLabel: o = "", disabled: s = !1, values: c = {}, errors: l = {}, termsHref: u = "", onFieldChange: m, onModeChange: h, onSubmit: g, navbar: _ = {}, footer: v = {}, backgroundLightSrc: x = "", backgroundDarkSrc: S = "", className: C = "", mainClassName: w = "" }) {
	let T = Tt(r, i), E = r === J.ACCOUNT_CREATED, D = Dt(r), O = Et(r), A = {
	...
	function N({ id: e, label: n, value: r, error: i, placeholder: a, autoComplete: o }) {
		return /* @__PURE__ */ t(K, {
			id: e,
			label: n,
			type: "password",
	...
	function P() {
		return r === J.REGISTER ? /* @__PURE__ */ n(e, { children: [
			...
			/* @__PURE__ */ t(Ze, {
				...
				onChange: (e) => j("acceptedTerms", e.target.checked),
				disabled: s,
				status: l.acceptedTerms ? Ge.ERROR : void 0,
				statusMessage: l.acceptedTerms
			})
		] }) : r === J.FORGOT_PASSWORD ? M("forgot-password-email") : r === J.RESET_PASSWORD || r === J.CHANGE_PASSWORD ? /* @__PURE__ */ n(e, { children: [N({
			id: "password",
			label: "New password",
			value: c.password,
			error: l.password,
			...
			/* @__PURE__ */ t(K, {
				...
				icon: ze,
				value: c.password || "",
				onChange: (e) => j("password", e.target.value),
					...
					children: [
						...
						E ? /* @__PURE__ */ t("div", {
							...
							children: [
								...
								/* @__PURE__ */ t("button", {
									type: "button",
									className: Ct("auth-portal-page__text-action", D.tone === "accent" ? "auth-portal-page__text-action--accent" : "auth-portal-page__text-action--muted"),
									onClick: () => h?.(D.nextMode),
									disabled: s,
									children: D.label
								})
							]
...
var hr = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, icon: c, selected: l = !1, className: u = "", containerClassName: m = "", selectClassName: h = "", labelClassName: g = "", helperClassName: _ = "", statusClassName: v = "", disabled: b = !1, required: x = !1, children: S, "aria-describedby": C, "aria-invalid": w, ...T }, E) {
	let D = o(), O = e ?? `fhl-select-${D}`, k = i ? `${O}-helper` : void 0, A = s ? `${O}-status` : void 0, j = pr(C, k, A), M = w ?? (a === G.ERROR ? !0 : void 0), N = mr(a, l), P = {
...
var ii = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, icon: c, selected: l = !1, className: u = "", containerClassName: m = "", textareaClassName: h = "", labelClassName: g = "", helperClassName: _ = "", statusClassName: v = "", disabled: b = !1, required: x = !1, rows: S = 4, resize: C = "vertical", "aria-describedby": w, "aria-invalid": T, ...E }, D) {
	let O = o(), k = e ?? `fhl-textarea-${O}`, A = i ? `${k}-helper` : void 0, j = s ? `${k}-status` : void 0, M = ni(w, A, j), N = T ?? (a === G.ERROR ? !0 : void 0), P = ri(a, l), F = {
...
function ci(e) {
	return e === ai.DARK ? Pe : e === ai.LIGHT ? je : Fe;
}
function li(e) {
	return e === "navy" ? {
...
//#endregion
export { J as AUTH_PORTAL_MODE, kt as AuthPortalPage, pe as AuthRedirectCard, j as BADGE_SIZE, A as BADGE_TONE, S as BUTTON_SHAPE, x as BUTTON_SIZE, b as BUTTON_VARIANT, L as Badge, k as Button, Ge as CHECKBOX_STATUS, z as CONTAINER_PADDING, V as CONTAINER_RADIUS, B as CONTAINER_SURFACE, Lt as Card, Ze as Checkbox, H as Container, Rt as DASHBOARD_RECORD_CARD_TONE, Nt as DashboardActivityFeed, It as DashboardBreadcrumb, jt as DashboardEmptyState, mn as DashboardNavbar, $t as DashboardProgressCard, Ut as DashboardRecordCard, Jt as DashboardRecordList, yn as DashboardRouteBar, Cn as DashboardTopbar, kn as DataTable, An as DefinitionList, Fn as EntityActionMenu, Bn as EntityListItem, ir as FILE_UPLOADER_STATUS, rr as FavoriteButton, lr as FileUploader, yr as HomeFilters, G as INPUT_STATUS, kr as ImageUploader, K as Input, U as LOGO_MODES, de as Logo, Ar as MetricCard, q as NOTICE_TONE, it as Notice, Rr as PROPERTY_DASHBOARD_CARD_FEEDBACK_TONE, Fr as PhotoCarouselModal, Lr as PhotoGallery, Ur as PropertyDashboardCard, lt as PublicFooter, St as PublicNavbar, Gr as QuickEditFieldDialog, ur as SELECT_STATUS, Wt as SKELETON_RADIUS, Kr as STAT_ITEM_SIZE, hr as Select, qt as Skeleton, Xr as StatItem, $r as TEXTAREA_STATUS, d as TEXT_SIZE, p as TEXT_TONE, f as TEXT_WEIGHT, ai as THEME_TOGGLE_MODE, Qr as Tabs, y as Text, ii as Textarea, ui as ThemeToggle, _i as UnitListingCard };
