...
var U = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, icon: c, trailingIcon: l, trailingIconAriaLabel: m = "Input action", onTrailingIconClick: h, selected: g = !1, type: _ = "text", showPasswordToggle: v = !0, className: b = "", containerClassName: x = "", inputClassName: S = "", labelClassName: C = "", helperClassName: w = "", statusClassName: T = "", disabled: E = !1, required: D = !1, "aria-describedby": O, "aria-invalid": k, ...A }, j) {
	let M = o(), N = e ?? `fhl-input-${M}`, P = i ? `${N}-helper` : void 0, F = s ? `${N}-status` : void 0, I = Je(O, P, F), L = k ?? (a === H.ERROR ? !0 : void 0), [ee, te] = u(!1), R = _ === "password" && v, ne = R && ee ? "text" : _, z = Ye(a, g), re = {
...
var Ot = "hidden min-h-0 flex-col md:!flex md:h-full md:border-b-0", K = "duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]";
function kt(e) {
	return /* @__PURE__ */ t("svg", {
		viewBox: "0 0 24 24",
		fill: "none",
...
function Nt(e) {
	return e ? `pointer-events-none max-w-0 -translate-x-1 overflow-hidden whitespace-nowrap opacity-0 transition-[max-width,opacity,transform] ${K}` : `max-w-[160px] translate-x-0 overflow-hidden whitespace-nowrap opacity-100 transition-[max-width,opacity,transform] ${K}`;
}
function Pt(e) {
...
function Rt({ item: r, collapsed: i = !1 }) {
	let a = r.icon, o = Pt(i), s = r.isActive ? `flex items-center rounded-xl py-2 text-sm font-semibold transition-[background-color,color] ${K} ${o} ${i ? "text-center" : ""}` : `flex items-center rounded-xl py-2 text-sm font-semibold transition-[background-color,color] hover:bg-[var(--fhl-navbar-hover-bg)] hover:text-[var(--fhl-navbar-text)] ${K} ${o} ${i ? "text-center" : ""}`, c = r.isActive ? {
		backgroundColor: "var(--fhl-navbar-active-bg)",
		color: "var(--fhl-navbar-active-text)"
	} : { color: "var(--fhl-navbar-text-muted)" }, l = Nt(i), u = Array.isArray(r.children) && r.children.length > 0 && r.showChildren && !i, d = /* @__PURE__ */ n(e, { children: [a ? /* @__PURE__ */ t(a, {
	...
	return /* @__PURE__ */ n("div", {
		...
		children: [r.href ? /* @__PURE__ */ t("a", {
			...
			children: r.children.map((e, n) => /* @__PURE__ */ t(Lt, { item: e }, jt(e, n)))
		}) : null]
	});
}
function zt({ item: r, collapsed: i = !1 }) {
	let a = r.icon, o = Nt(i), s = Pt(i), c = /* @__PURE__ */ n(e, { children: [a ? /* @__PURE__ */ t(a, {
		className: "h-5 w-5 shrink-0",
		"aria-hidden": "true",
		focusable: "false"
	}) : null, /* @__PURE__ */ t("span", {
	...
	return r.href ? /* @__PURE__ */ t("a", {
		href: r.href,
		onClick: r.onClick,
		className: `flex items-center rounded-xl py-2 text-sm font-semibold transition-[background-color,color] hover:bg-[var(--fhl-navbar-hover-bg)] ${K} ${s} ${i ? "text-center" : ""}`,
		...
		type: "button",
		onClick: r.onClick,
		className: `flex w-full items-center rounded-xl py-2 text-left text-sm font-semibold transition-[background-color,color] hover:bg-[var(--fhl-navbar-hover-bg)] ${K} ${s} ${i ? "text-center" : ""}`,
		style: { color: "var(--fhl-navbar-text-muted)" },
		title: i ? r.label : void 0,
		children: c
	});
}
function Bt({ brand: r, navItems: i = [], navSections: o = [], footerItems: s = [], className: l = "", style: d, collapsed: f = !1, collapseToggle: p, isSigningOut: m = !1, onSignOut: h, signOutIcon: g, signOutLabel: _ = "Log out", signingOutLabel: v = "Signing out...", supportItem: y, supportLabel: b = "Call support", supportHref: x = "tel:+13055550199", supportIcon: S = kt, requireSignOutConfirmation: C = !0, signOutConfirmationTitle: w = "Sign out?", signOutConfirmationMessage: T = "You will need to sign in again to access this dashboard.", signOutConfirmationLabel: E = "Sign out", signOutCancelLabel: D = "Cancel", mobileDrawer: O = !1, mobileOpen: k = !1, onMobileClose: A, mobileWidthClassName: j = "w-72 max-w-[calc(100vw-1.5rem)]", mobileCloseLabel: M = "Close menu", mobileCloseIcon: N = At }) {
	let [P, F] = u(!1), I = O && k, L = I ? !1 : f, ee = O ? [
		k ? "!fixed inset-y-0 left-0 z-[70] !flex h-[100dvh]" : "hidden",
		"md:!relative md:inset-auto md:z-auto md:!flex md:h-full md:border-b-0",
		l,
		k ? j : ""
	].filter(Boolean).join(" ").trim() : `${Ot} ${l}`.trim(), te = Ft(r), R = c(() => {
		...
		y,
		b
	]), ne = !!R || s.length > 0 || h, z = Array.isArray(o) && o.length > 0 ? o : [{ items: i }];
	a(() => {
		if (!I) return;
	...
	return /* @__PURE__ */ n(e, { children: [
		...
		/* @__PURE__ */ n("aside", {
			...
			children: [
				p?.onToggle || I ? /* @__PURE__ */ n("div", {
					className: `flex h-20 border-b px-2 py-2 transition-[justify-content,padding] ${K} ${L ? "justify-center" : "items-center justify-between"}`,
					...
					children: [
						te ? /* @__PURE__ */ t("a", {
							...
							className: `inline-flex items-center overflow-hidden rounded-md p-1 transition-[max-width,opacity,transform] ${K} ${L ? "pointer-events-none max-w-0 -translate-x-2 opacity-0" : "max-w-[11rem] translate-x-0 opacity-100"}`,
							children: te
						}) : null,
						I ? /* @__PURE__ */ t("button", {
							type: "button",
						...
						p?.onToggle ? /* @__PURE__ */ t("button", {
							type: "button",
							onClick: p.onToggle,
							className: `hidden rounded-md p-1.5 transition hover:bg-[var(--fhl-navbar-hover-bg)] md:inline-flex ${K}`,
							style: {
								backgroundColor: "var(--fhl-navbar-surface-soft)",
								color: "var(--fhl-navbar-text)"
							},
							"aria-label": L ? p.collapsedLabel ?? "Expand menu" : p.expandedLabel ?? "Collapse menu",
							title: L ? p.collapsedLabel ?? "Expand menu" : p.expandedLabel ?? "Collapse menu",
							children: L ? p.collapsedIcon : p.expandedIcon
						}) : null
					]
				}) : te ? /* @__PURE__ */ t("div", {
				...
				ne ? /* @__PURE__ */ n("div", {
					...
					children: [
						...
						h ? /* @__PURE__ */ n("button", {
							...
							onClick: re,
							disabled: m,
							className: `flex w-full items-center rounded-xl py-2 text-left text-sm font-semibold transition-[background-color,color] hover:bg-[var(--fhl-navbar-hover-bg)] disabled:opacity-60 ${K} ${Pt(L)}`,
							style: { color: "var(--fhl-navbar-text-muted)" },
							"aria-label": m ? v : _,
							title: L ? _ : void 0,
...
function Jt({ dashboardLabel: e = "Dashboard", currentTabLabel: r = "Overview", currentTabHint: i = "", displayName: a = "User", userLabel: o = "Logged user", topbarBadges: s = [], avatarContent: c, mobileMenuButton: l, className: u = "", style: d }) {
	let f = String(a || "User").trim() || "User", p = c ?? f.charAt(0).toUpperCase(), m = `px-4 py-3 md:px-5 ${u}`.trim(), h = l?.icon ?? qt, g = l?.label ?? "Open menu";
	return /* @__PURE__ */ t("header", {
		className: m,
		style: {
			backgroundColor: "var(--fhl-color-surface)",
...
var q = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, icon: c, selected: l = !1, className: u = "", containerClassName: m = "", selectClassName: h = "", labelClassName: g = "", helperClassName: _ = "", statusClassName: v = "", disabled: b = !1, required: x = !1, children: S, "aria-describedby": C, "aria-invalid": w, ...T }, E) {
	let D = o(), O = e ?? `fhl-select-${D}`, k = i ? `${O}-helper` : void 0, A = s ? `${O}-status` : void 0, j = zn(C, k, A), M = w ?? (a === H.ERROR ? !0 : void 0), N = Bn(a, l), P = {
...
var J = "flex flex-col gap-1.5", Y = "text-xs font-semibold tracking-wide uppercase text-[var(--fhl-color-text-muted)]", X = "min-h-10 rounded-xl border-[var(--fhl-color-border)] px-3 py-2 shadow-none", Z = "text-sm", Un = "h-8 px-3 shadow-none transition-colors duration-200";
		...
		children: [/* @__PURE__ */ n("div", {
			...
			children: [
				/* @__PURE__ */ t(U, {
					...
					className: `${J} col-span-2 min-w-0 md:col-span-1`,
					labelClassName: Y,
...
function yr({ as: e = "div", className: n = "", radius: r = Q.MD, shimmer: i = !0, style: a, ...o }) {
	return /* @__PURE__ */ t(e, {
		"aria-hidden": "true",
		className: vr("fhl-skeleton", _r[r] ?? _r[Q.MD], i ? "fhl-skeleton--shimmer" : "", n),
		style: a,
		...o
	});
}
...
function Cr({ icon: e, value: r, label: i, size: a = $.MD, align: o = "center", className: s = "" }) {
	return /* @__PURE__ */ n("div", {
		className: Sr("flex items-center gap-3 px-2", o === "center" ? "justify-center" : "justify-start", s),
		children: [e ? /* @__PURE__ */ t(e, {
			className: Sr(br[a] ?? br.md, "shrink-0 text-[var(--fhl-color-primary)]"),
			"aria-hidden": "true",
			focusable: "false"
		}) : null, /* @__PURE__ */ n("div", {
			className: "text-left",
...
function Tr({ items: e = [], activeKey: n, onSelect: r, className: i = "" }) {
	return /* @__PURE__ */ t("nav", {
		className: wr("flex gap-8 overflow-x-auto border-b text-sm font-semibold text-[var(--fhl-color-text-muted)]", i),
		style: { borderColor: "var(--fhl-color-border)" },
		children: e.map((e) => {
			let i = e.key === n;
			return /* @__PURE__ */ t("a", {
				href: e.href,
				onClick: (t) => r?.(e.key, t),
				className: wr("shrink-0 border-b-2 px-1 py-4 transition hover:text-[var(--fhl-color-accent)]", i ? "border-[var(--fhl-color-accent)] text-[var(--fhl-color-accent)]" : "border-transparent"),
				children: e.label
			}, e.key);
		})
	});
...
var jr = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, icon: c, selected: l = !1, className: u = "", containerClassName: m = "", textareaClassName: h = "", labelClassName: g = "", helperClassName: _ = "", statusClassName: v = "", disabled: b = !1, required: x = !1, rows: S = 4, resize: C = "vertical", "aria-describedby": w, "aria-invalid": T, ...E }, D) {
	let O = o(), k = e ?? `fhl-textarea-${O}`, A = i ? `${k}-helper` : void 0, j = s ? `${k}-status` : void 0, M = kr(w, A, j), N = T ?? (a === H.ERROR ? !0 : void 0), P = Ar(a, l), F = {
	...
	return /* @__PURE__ */ n("div", {
		className: Or("w-full space-y-1.5", u),
		children: [
			r ? /* @__PURE__ */ n(y, {
				as: "label",
				htmlFor: k,
				size: d.SM,
				weight: f.SEMIBOLD,
				className: Or("block text-[var(--fhl-input-label)]", g),
				children: [r, x ? /* @__PURE__ */ t("span", {
					className: "ml-1 text-[var(--fhl-color-primary)]",
					children: "*"
				}) : null]
			...
			/* @__PURE__ */ n("div", {
				className: Or("flex gap-3 rounded-2xl border px-3.5 py-3 shadow-sm transition", "border-[var(--fhl-textarea-current-border)] bg-[var(--fhl-textarea-current-bg)]", "focus-within:border-[var(--fhl-textarea-current-border)]", "focus-within:ring-4 focus-within:ring-[var(--fhl-textarea-current-ring)]", b ? "cursor-not-allowed" : "", m),
				style: F,
			...
			i ? /* @__PURE__ */ t(y, {
				...
				weight: f.MEDIUM,
				tone: p.MUTED,
				className: Or("text-[var(--fhl-input-helper)]", _),
				children: i
			}) : null,
			s ? /* @__PURE__ */ t(y, {
				as: "p",
...
function Fr(e) {
	return e === Mr.DARK ? Oe : e === Mr.LIGHT ? Te : ke;
}
function Ir(e) {
	return e === "navy" ? {
...
function Lr({ value: e = Mr.SYSTEM, onChange: r, options: i = Nr, compact: a = !1, tone: o = "surface", className: s = "", ariaLabel: c = "Theme mode", disabled: l = !1 }) {
	return /* @__PURE__ */ t("div", {
		role: "radiogroup",
		"aria-label": c,
...
var Rr = new Intl.NumberFormat("en-US", {
	style: "currency",
	currency: "USD",
	maximumFractionDigits: 0
}), zr = new Intl.NumberFormat("en-US", { maximumFractionDigits: 0 });
function Br(e) {
	if (e == null || e === "") return "—";
	let t = Number(e);
	return Number.isFinite(t) ? zr.format(t) : "—";
}
function Vr(e) {
	let t = String(e || "").trim();
...
function Ur(e) {
	...
	return [[t, n].filter(Boolean).join(", "), r].filter(Boolean).join(" ") || Hr(e);
}
function Wr({ listing: e, onNavigate: r, isFavorite: i = !1, isFavoriteSaving: a = !1, onToggleFavorite: o }) {
	let s = Number(e.rentAmount), c = Number.isFinite(s), l = Vr(e.property.propertyType), u = Number(e.parkingSpaces), m = Number.isFinite(u) && u > 0;
	return /* @__PURE__ */ n("article", {
				...
				children: [
					...
					/* @__PURE__ */ n("div", {
						...
						children: [/* @__PURE__ */ n("div", {
							...
							children: [c ? Rr.format(s) : "Price", /* @__PURE__ */ t(y, {
								as: "span",
								size: d.XS,
								tone: p.MUTED,
								weight: f.SEMIBOLD,
					...
					/* @__PURE__ */ n("div", {
						...
						children: [
							/* @__PURE__ */ n(y, {
								...
								children: [/* @__PURE__ */ t(_n, { className: "h-3.5 w-3.5 text-[var(--fhl-color-primary)]" }), m ? `${Br(e.parkingSpaces)} parking` : "No parking"]
							}),
							/* @__PURE__ */ n(y, {
								as: "span",
								size: d.XS,
...
//#endregion
export { G as AUTH_PORTAL_MODE, Ct as AuthPortalPage, se as AuthRedirectCard, S as BUTTON_SHAPE, x as BUTTON_SIZE, b as BUTTON_VARIANT, k as Button, ze as CHECKBOX_STATUS, M as CONTAINER_PADDING, P as CONTAINER_RADIUS, N as CONTAINER_SURFACE, Dt as Card, Ge as Checkbox, R as Container, Et as DashboardBreadcrumb, Bt as DashboardNavbar, Gt as DashboardRouteBar, Jt as DashboardTopbar, en as DataTable, tn as DefinitionList, sn as EntityActionMenu, fn as EntityListItem, An as FILE_UPLOADER_STATUS, kn as FavoriteButton, Fn as FileUploader, Wn as HomeFilters, H as INPUT_STATUS, er as ImageUploader, U as Input, B as LOGO_MODES, ae as Logo, tr as MetricCard, W as NOTICE_TONE, Qe as Notice, lr as PROPERTY_DASHBOARD_CARD_FEEDBACK_TONE, or as PhotoCarouselModal, cr as PhotoGallery, mr as PropertyDashboardCard, rt as PublicFooter, gt as PublicNavbar, gr as QuickEditFieldDialog, In as SELECT_STATUS, Q as SKELETON_RADIUS, $ as STAT_ITEM_SIZE, q as Select, yr as Skeleton, Cr as StatItem, Er as TEXTAREA_STATUS, d as TEXT_SIZE, p as TEXT_TONE, f as TEXT_WEIGHT, Mr as THEME_TOGGLE_MODE, Tr as Tabs, y as Text, jr as Textarea, Lr as ThemeToggle, Wr as UnitListingCard };
