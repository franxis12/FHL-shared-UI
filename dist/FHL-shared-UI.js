...
var A = Object.freeze({
	...
	[A.NEUTRAL]: {
		...
		color: "color-mix(in oklab, var(--fhl-color-text-muted) 85%, var(--fhl-color-text) 15%)"
	},
	[A.INFO]: {
	...
	[A.SUCCESS]: {
		...
		color: "color-mix(in oklab, var(--fhl-color-success) 85%, var(--fhl-color-text) 15%)"
	},
	[A.WARNING]: {
		backgroundColor: "var(--fhl-color-warning-soft)",
		borderColor: "var(--fhl-color-warning-border)",
		color: "color-mix(in oklab, var(--fhl-color-warning) 85%, var(--fhl-color-text) 15%)"
	},
	[A.ERROR]: {
		backgroundColor: "var(--fhl-color-alert-soft)",
		borderColor: "var(--fhl-color-alert-border)",
		color: "color-mix(in oklab, var(--fhl-color-alert) 85%, var(--fhl-color-text) 15%)"
	}
}, N = {
	[j.SM]: "px-2.5 py-1 text-[11px]",
	[j.MD]: "px-3 py-1.5 text-xs"
}, P = {
	[j.SM]: "h-3.5 w-3.5",
	[j.MD]: "h-4 w-4"
};
...
function ee(e) {
	return Object.fromEntries(Object.entries(e).filter(([e]) => I.has(e) || e.startsWith("aria-") || e.startsWith("data-")));
}
function L({ children: e, tone: r = A.NEUTRAL, size: i = j.SM, icon: a, uppercase: o = !1, ...s }) {
	let c = ee(s), l = M[r] ?? M[A.NEUTRAL], u = N[i] ?? N[j.SM], d = P[i] ?? P[j.SM];
	return /* @__PURE__ */ n("span", {
		...c,
		className: F("inline-flex max-w-full items-center gap-1.5 rounded-full border font-semibold", "break-words", u, o ? "uppercase tracking-[0.12em]" : ""),
		style: l,
		children: [a ? /* @__PURE__ */ t(a, {
			className: F(d, "shrink-0"),
			"aria-hidden": "true",
			focusable: "false"
...
function ae(e) {
	return te[e] ?? te.default;
}
function oe({ title: e, description: r, headerAction: i, padding: a, divided: o, headerClassName: s, titleClassName: c, descriptionClassName: l }) {
	return !e && !r && !i ? null : /* @__PURE__ */ n("div", {
		className: re("flex items-start justify-between gap-4", ie(a), o ? "border-b" : "", s),
...
function H({ as: e = "section", title: r, description: i, header: a, headerAction: o, footer: s, children: c, className: l = "", contentClassName: u = "", headerClassName: d = "", footerClassName: f = "", titleClassName: p = "", descriptionClassName: m = "", padding: h = z.MD, surface: g = B.DEFAULT, radius: _ = V.XL, fitContent: v = !1, divided: y = !1, bordered: b = !0, shadow: x = !0, style: S, ...C }) {
	let w = ie(h), T = !a && (r || i || o), E = !!s;
	return /* @__PURE__ */ n(e, {
		...C,
		className: re(v ? "inline-flex max-w-full" : "flex", "flex-col overflow-hidden", ne[_] ?? ne[V.XL], b ? "border" : "", x ? "shadow-[0_24px_60px_-30px_var(--fhl-container-shadow)]" : "", l),
		style: {
		...
		children: [
			a ? /* @__PURE__ */ t("div", {
				className: re(ie(h), y ? "border-b" : "", d),
				style: { borderColor: "var(--fhl-container-border)" },
				children: a
			}) : null,
			T ? /* @__PURE__ */ t(oe, {
...
function de({ mode: r = U.HORIZONTAL, darkMode: i = U.DARK, themeAware: a = !1, className: o = "", lightClassName: s, darkClassName: c }) {
	let l = ue(r), u = ue(i), d = s ?? o, f = c ?? o;
...
var me = {
	...
	style: void 0,
	attr: void 0
}, he = r.createContext && /*#__PURE__*/ r.createContext(me), ge = [
	"attr",
	"size",
	"title"
];
...
function Te(e) {
	return e && e.map((e, t) => /*#__PURE__*/ r.createElement(e.tag, xe({ key: t }, e.attr), Te(e.child)));
}
function W(e) {
	return (t) => /*#__PURE__*/ r.createElement(Ee, ye({ attr: xe({}, e.attr) }, t), Te(e.child));
}
function Ee(e) {
	var t = (t) => {
		var n = e.attr, i = e.size, a = e.title, o = _e(e, ge), s = i || t.size || "1em", c;
		return t.className && (c = t.className), e.className && (c = (c ? c + " " : "") + e.className), /*#__PURE__*/ r.createElement("svg", ye({
			stroke: "currentColor",
			fill: "currentColor",
			strokeWidth: "0"
		}, t.attr, n, o, {
			className: c,
			style: xe(xe({ color: e.color || t.color }, t.style), e.style),
			height: s,
			width: s,
			xmlns: "http://www.w3.org/2000/svg"
		}), a && /*#__PURE__*/ r.createElement("title", null, a), e.children);
	};
	return he === void 0 ? t(me) : /*#__PURE__*/ r.createElement(he.Consumer, null, (e) => t(e));
}
//#endregion
...
var Ze = i(function({ id: e, label: r, helperText: i, status: s, statusMessage: c, selected: u = !1, indeterminate: m = !1, className: h = "", controlClassName: g = "", labelClassName: _ = "", helperClassName: v = "", statusClassName: b = "", disabled: x = !1, required: S = !1, "aria-describedby": C, "aria-invalid": w, ...T }, E) {
	let D = o(), O = e ?? `fhl-checkbox-${D}`, k = i ? `${O}-helper` : void 0, A = c ? `${O}-status` : void 0, j = Je(C, k, A), M = w ?? (s === Ge.ERROR ? !0 : void 0), N = Ye(s, u), P = l(null);
	a(() => {
	...
	return /* @__PURE__ */ n("div", {
		className: qe("w-full space-y-1.5", h),
		children: [/* @__PURE__ */ n("label", {
			htmlFor: O,
			className: qe("flex w-full items-start gap-3", x ? "cursor-not-allowed opacity-70" : "cursor-pointer"),
			children: [/* @__PURE__ */ n("span", {
				...
				children: [r ? /* @__PURE__ */ n(y, {
					...
					size: d.SM,
					weight: f.SEMIBOLD,
					className: qe("block text-[var(--fhl-checkbox-label)]", _),
					...
					weight: f.MEDIUM,
					tone: p.MUTED,
					className: qe("text-[var(--fhl-checkbox-helper)]", v),
					children: i
				}) : null]
			})]
		}), c ? /* @__PURE__ */ t(y, {
	...
	return /* @__PURE__ */ n("div", {
		...
		children: [
			r ? /* @__PURE__ */ n(y, {
				...
				size: d.SM,
				weight: f.SEMIBOLD,
				className: $e("block text-[var(--fhl-input-label)]", C),
			...
			/* @__PURE__ */ n("div", {
				className: $e("flex min-h-12 items-center gap-3 rounded-2xl border px-3.5 py-3 shadow-sm transition", "border-[var(--fhl-input-current-border)] bg-[var(--fhl-input-current-bg)]", "focus-within:border-[var(--fhl-input-current-border)]", "focus-within:ring-4 focus-within:ring-[var(--fhl-input-current-ring)]", E ? "cursor-not-allowed" : "", x),
				style: V,
				children: [
					c ? /* @__PURE__ */ t(c, {
					...
					/* @__PURE__ */ t("input", {
						...
						"aria-describedby": I,
						"aria-invalid": ee,
						className: $e("min-w-0 flex-1 bg-transparent text-[length:var(--fhl-text-size-sm)] leading-[var(--fhl-text-leading-sm)] font-medium text-[var(--fhl-input-text)] outline-none", "placeholder:text-[var(--fhl-input-placeholder)] disabled:cursor-not-allowed disabled:text-[var(--fhl-input-disabled-text)]", S)
					}),
					ne ? /* @__PURE__ */ n("div", {
			...
			i ? /* @__PURE__ */ t(y, {
				...
				weight: f.MEDIUM,
				tone: p.MUTED,
				className: $e("text-[var(--fhl-input-helper)]", w),
				children: i
			}) : null,
			s ? /* @__PURE__ */ t(y, {
				as: "p",
...
function it({ tone: e = q.INFO, children: n, className: r = "", textClassName: i = "" }) {
	if (!n) return null;
	let a = nt[e] ?? nt[q.INFO];
	return /* @__PURE__ */ t("div", {
		className: rt("rounded-2xl border px-4 py-3", r),
		style: {
...
function ct(e, n, { compact: r = !1 } = {}) {
	return e?.label ? /* @__PURE__ */ t("a", {
		href: e.href || "#",
		onClick: e.onClick,
		target: e.target,
		rel: e.rel,
		className: ot({ compact: r }),
		children: e.label
	}, n) : null;
}
function lt({ brand: r = "FHL Enterprises Group", brandHref: i = "", onBrandClick: a, description: o = "", sections: s = [], socialLinks: c = [], signInLink: l = null, bottomLinks: u = [], copyrightLabel: p = "", navItems: m = [], aside: h = null, className: g = "", contentClassName: _ = "" }) {
	let v = Array.isArray(s) && s.length > 0 ? s : st(m), b = (/* @__PURE__ */ new Date()).getFullYear(), x = p || r, S = /* @__PURE__ */ n(e, { children: [/* @__PURE__ */ t("span", {
		className: "sr-only",
		children: r
	}), /* @__PURE__ */ t(de, {
		mode: U.DARK,
	...
	return /* @__PURE__ */ t("footer", {
		className: at("mt-16 border-t px-4 py-8 md:px-8", g),
		style: {
		...
		children: /* @__PURE__ */ n("div", {
			className: at("mx-auto max-w-7xl space-y-6", _),
			children: [/* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ n("div", {
					...
					children: [i ? /* @__PURE__ */ t("a", {
						...
						children: c.map((e, t) => ct(e, `${e.label}-${e.href || t}`))
					}) : null]
					...
					children: v.map((e, r) => /* @__PURE__ */ n("section", {
						...
						children: [e.title ? /* @__PURE__ */ t(y, {
							...
							className: "space-y-2",
							children: e.links.map((e, n) => /* @__PURE__ */ t("li", { children: ct(e, `${e.label}-${e.href || n}`) }, `${e.label}-${e.href || n}`))
						}) : null]
					}, e.title || `section-${r}`))
				}) : null]
			}), /* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ n("div", {
					...
					children: [/* @__PURE__ */ n(y, {
						...
						children: u.map((e, t) => ct(e, `${e.label}-${e.href || t}`, { compact: !0 }))
					})]
				}), h ? /* @__PURE__ */ t("div", {
...
var ut = 2600, dt = "var(--fhl-navy-text)", ft = "var(--fhl-navy-border)", pt = "var(--fhl-public-navbar-bg)", mt = "var(--fhl-public-navbar-menu-bg)", ht = "color-mix(in oklab, var(--fhl-primary-navy) 88%, white)", gt = "0 14px 34px rgba(6, 43, 73, 0.22)", _t = "0 18px 42px rgba(6, 43, 73, 0.28)";
function vt(e) {
	return [
...
function xt({ danger: e = !1 } = {}) {
	return bt("block w-full rounded-xl px-4 py-3 text-left text-sm font-semibold transition", e ? "hover:bg-[rgba(252,165,165,0.12)]" : "hover:bg-white/8");
}
function St({ logoHref: r = "/", onLogoClick: i, navItems: o = [], isAuthenticated: s = !1, userDisplayName: c = "User", userEmail: d = "", avatarUrl: f = "", dashboardHref: p = "", loginHref: m = "", onDashboardClick: h, onSignOut: g }) {
	let [_, v] = u(!1), [y, b] = u(!1), [x, S] = u(""), C = l(null), w = l(null), T = l(null), E = yt(c, d), D = !!(f && x !== f);
	function O() {
							...
							children: /* @__PURE__ */ n(H, {
								...
								children: [
									o.length > 0 ? /* @__PURE__ */ t("div", {
										...
										style: { borderColor: ft },
										children: F({ mobileOnly: !0 })
									}) : null,
									/* @__PURE__ */ t("a", {
										href: p,
										onClick: (e) => {
...
//#endregion
//#region src/components/AuthPortalPage/AuthPortalPage.jsx
var J = Object.freeze({
...
function wt(e) {
	return e === q.ERROR || e === "error" ? q.ERROR : e === q.SUCCESS || e === "success" ? q.SUCCESS : e === q.WARNING || e === "warning" ? q.WARNING : q.INFO;
}
function Tt(e, t) {
	return t || (e === J.REGISTER ? "Create Account" : e === J.CHANGE_PASSWORD ? "Change Password" : e === J.FORGOT_PASSWORD ? "Forgot Password" : e === J.RESET_PASSWORD ? "Reset Password" : "Sign In");
}
function Et(e) {
	return e === J.REGISTER ? ke : e === J.CHANGE_PASSWORD || e === J.RESET_PASSWORD ? ze : e === J.FORGOT_PASSWORD ? Le : Re;
}
function Dt(e) {
	return e === J.LOGIN ? {
		...
		nextMode: J.LOGIN,
		tone: "accent"
	} : e === J.CHANGE_PASSWORD || e === J.FORGOT_PASSWORD ? {
		label: "Back to login",
		nextMode: J.LOGIN,
		tone: "accent"
	} : {
		label: "Request another reset link",
		nextMode: J.FORGOT_PASSWORD,
		tone: "accent"
	};
}
function Ot(e) {
	return e ? /* @__PURE__ */ n("span", { children: [
		"I agree to the",
		" ",
		/* @__PURE__ */ t("a", {
			href: e,
		...
		"."
	] }) : /* @__PURE__ */ t("span", { children: "I agree to the terms and conditions." });
}
function kt({ mode: r = J.LOGIN, title: i = "", notice: a = null, submitLabel: o = "", disabled: s = !1, values: c = {}, errors: l = {}, termsHref: u = "", onFieldChange: m, onModeChange: h, onSubmit: g, navbar: _ = {}, footer: v = {}, backgroundLightSrc: x = "", backgroundDarkSrc: S = "", className: C = "", mainClassName: w = "" }) {
	let T = Tt(r, i), E = Dt(r), D = Et(r), O = {
		"--fhl-auth-light-image": x ? `url("${x}")` : "none",
		"--fhl-auth-dark-image": S ? `url("${S}")` : "none"
	};
	function A(e, t) {
		m?.(e, t);
	}
	function j(e) {
		return /* @__PURE__ */ t(K, {
			...
			autoComplete: "email",
			disabled: s,
			status: l.email ? G.ERROR : void 0,
			statusMessage: l.email
		});
	}
	function M({ id: e, label: n, value: r, error: i, placeholder: a, autoComplete: o }) {
		return /* @__PURE__ */ t(K, {
			id: e,
			label: n,
			type: "password",
			icon: ze,
			value: r || "",
			onChange: (t) => A(e, t.target.value),
			placeholder: a,
			autoComplete: o,
			disabled: s,
			status: i ? G.ERROR : void 0,
			statusMessage: i
		});
	}
	function N() {
		return r === J.REGISTER ? /* @__PURE__ */ n(e, { children: [
			/* @__PURE__ */ n("div", {
				className: "auth-portal-page__name-row",
				children: [/* @__PURE__ */ t(K, {
					id: "firstName",
					label: "First name",
					type: "text",
					...
					disabled: s,
					status: l.firstName ? G.ERROR : void 0,
					statusMessage: l.firstName
				}), /* @__PURE__ */ t(K, {
					id: "lastName",
					label: "Last name",
					type: "text",
					...
					disabled: s,
					status: l.lastName ? G.ERROR : void 0,
					statusMessage: l.lastName
				})]
			}),
			j("email"),
			/* @__PURE__ */ t(K, {
				...
				autoComplete: "tel",
				disabled: s,
				status: l.phone ? G.ERROR : void 0,
				statusMessage: l.phone
			}),
			/* @__PURE__ */ n("div", {
				className: "auth-portal-page__pair-row",
				children: [M({
					id: "password",
					label: "Password",
					value: c.password,
			...
			/* @__PURE__ */ t(Ze, {
				...
				checked: !!c.acceptedTerms,
				onChange: (e) => A("acceptedTerms", e.target.checked),
				disabled: s,
				status: l.acceptedTerms ? Ge.ERROR : void 0,
				statusMessage: l.acceptedTerms
			})
		] }) : r === J.FORGOT_PASSWORD ? j("forgot-password-email") : r === J.RESET_PASSWORD || r === J.CHANGE_PASSWORD ? /* @__PURE__ */ n(e, { children: [M({
			id: "password",
			label: "New password",
			value: c.password,
			error: l.password,
			...
			/* @__PURE__ */ t(K, {
				...
				disabled: s,
				status: l.password ? G.ERROR : void 0,
				statusMessage: l.password
			}),
			/* @__PURE__ */ t("button", {
				type: "button",
				className: Ct("auth-portal-page__text-action", "auth-portal-page__text-action--muted"),
				onClick: () => h?.(J.FORGOT_PASSWORD),
				disabled: s,
	...
	return /* @__PURE__ */ n("div", {
		className: Ct("auth-portal-page", C),
		style: O,
		children: [
			/* @__PURE__ */ t(St, { ..._ }),
			/* @__PURE__ */ t("main", {
				className: Ct("auth-portal-page__main", w),
				children: /* @__PURE__ */ n(H, {
					...
					children: [
						/* @__PURE__ */ t("div", {
							className: "auth-portal-page__brand",
							children: /* @__PURE__ */ t(de, {
								mode: U.HORIZONTAL,
								darkMode: U.DARK,
								themeAware: !0,
						...
						/* @__PURE__ */ t("div", {
							className: "auth-portal-page__header",
							children: /* @__PURE__ */ t(y, {
								as: "h1",
								size: d.TWO_XL,
								weight: f.BOLD,
						...
						a?.message ? /* @__PURE__ */ t(it, {
							tone: wt(a.tone),
							children: a.message
						}) : null,
						/* @__PURE__ */ n("form", {
							className: "auth-portal-page__form",
							onSubmit: g,
							children: [
								N(),
								/* @__PURE__ */ t(k, {
								...
								/* @__PURE__ */ t("button", {
									type: "button",
									className: Ct("auth-portal-page__text-action", E.tone === "accent" ? "auth-portal-page__text-action--accent" : "auth-portal-page__text-action--muted"),
									onClick: () => h?.(E.nextMode),
									disabled: s,
									children: E.label
								})
							]
			...
			/* @__PURE__ */ t("div", {
				className: "auth-portal-page__footer",
				children: /* @__PURE__ */ t(lt, { ...v })
			})
		]
	});
}
//#endregion
//#region src/components/DashboardEmptyState/DashboardEmptyState.jsx
function At(...e) {
	return e.filter(Boolean).join(" ");
}
function jt({ title: e, description: r, actionLabel: i, actionHref: a, onActionClick: o, actionVariant: s = b.SECONDARY, className: c = "" }) {
	return /* @__PURE__ */ n("div", {
		className: At("rounded-2xl border border-dashed p-5", c),
		style: {
			borderColor: "var(--fhl-color-border)",
			backgroundColor: "var(--fhl-color-surface-soft)"
		},
...
//#endregion
//#region src/components/DashboardActivityFeed/DashboardActivityFeed.jsx
var Mt = {
	default: {
		backgroundColor: "var(--fhl-color-surface-soft)",
...
function Nt({ title: e = "Activity Feed", description: r = "", items: i = [], emptyTitle: a = "No activity yet", emptyDescription: o = "" }) {
	return /* @__PURE__ */ t(H, {
		title: e,
		description: r,
		padding: z.MD,
		radius: V.XL,
		surface: B.DEFAULT,
		children: i.length === 0 ? /* @__PURE__ */ t(jt, {
			title: a,
			description: o
		}) : /* @__PURE__ */ t("div", {
			className: "space-y-4",
			children: i.map((e, r) => /* @__PURE__ */ n("div", {
				className: "flex gap-3",
				children: [/* @__PURE__ */ t("div", {
					className: "grid h-10 w-10 shrink-0 place-items-center rounded-full",
					style: Mt[e.tone] ?? Mt.default,
					children: /* @__PURE__ */ t("span", { className: "h-3 w-3 rounded-full bg-current" })
				}), /* @__PURE__ */ n("div", {
					className: "min-w-0",
					children: [
						/* @__PURE__ */ t(y, {
...
function It({ items: e = [], className: r = "" }) {
...
function Lt({ title: e, children: r, icon: i }) {
...
//#endregion
//#region src/components/DashboardRecordCard/DashboardRecordCard.jsx
...
function Vt({ label: e }) {
	return /* @__PURE__ */ t("div", {
		className: "flex h-full w-full items-center justify-center bg-[var(--fhl-color-surface)] px-3 text-center",
		children: /* @__PURE__ */ t(y, {
			as: "span",
			size: d.XS,
			tone: p.MUTED,
...
function Ht({ label: e, tone: n }) {
	if (!e) return null;
	let r = zt[n] ?? zt.default;
...
function Ut({ imageUrl: e = "", imageAlt: r = "", imageFallbackLabel: i = "No image available", title: a, subtitle: o = "", meta: s = "", statusLabel: c = "", statusTone: l = Rt.DEFAULT, actions: u = [], className: m = "" }) {
	let h = Array.isArray(u) ? u.filter((e) => e && e.label) : [];
	return /* @__PURE__ */ t("article", {
		className: Bt("rounded-3xl border p-4", m),
		style: {
			borderColor: "var(--fhl-color-border)",
			backgroundColor: "var(--fhl-color-surface-soft)"
		},
		children: /* @__PURE__ */ n("div", {
			className: "flex gap-3",
			children: [/* @__PURE__ */ t("div", {
				className: "h-24 w-24 shrink-0 overflow-hidden rounded-2xl bg-[var(--fhl-color-surface)]",
				children: e ? /* @__PURE__ */ t("img", {
					src: e,
					alt: r || a,
					className: "h-full w-full object-cover",
					loading: "lazy"
				}) : /* @__PURE__ */ t(Vt, { label: i })
			}), /* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ n("div", {
					...
					children: h.map((e, n) => /* @__PURE__ */ t(k, {
						href: e.href,
						onClick: e.onClick,
						disabled: !!e.isLoading,
						variant: e.variant ?? b.PRIMARY,
						size: x.SM,
						shape: S.PILL,
						className: e.className ?? "",
						children: e.isLoading ? e.loadingLabel ?? e.label : e.label
					}, e.key ?? `${e.label}-${n}`))
				}) : null]
			})]
		})
...
var Wt = Object.freeze({
	...
	[Wt.MD]: "rounded-xl",
	[Wt.LG]: "rounded-2xl",
	[Wt.XL]: "rounded-[1.5rem]",
	[Wt.FULL]: "rounded-full"
};
function Kt(...e) {
	return e.filter(Boolean).join(" ");
}
function qt({ as: e = "div", className: n = "", radius: r = Wt.MD, shimmer: i = !0, style: a, ...o }) {
	return /* @__PURE__ */ t(e, {
		"aria-hidden": "true",
		className: Kt("fhl-skeleton", Gt[r] ?? Gt[Wt.MD], i ? "fhl-skeleton--shimmer" : "", n),
		style: a,
		...o
	});
}
//#endregion
//#region src/components/DashboardRecordList/DashboardRecordList.jsx
function Jt({ title: e, description: n = "", items: r = [], isLoading: i = !1, loadingCount: a = 3, emptyTitle: o = "Nothing here yet", emptyDescription: s = "", emptyActionLabel: c = "", emptyActionHref: l, onEmptyActionClick: u, headerAction: d = null, surface: f = B.DEFAULT }) {
	return /* @__PURE__ */ t(H, {
		title: e,
		description: n,
		headerAction: d,
		...
		children: i ? /* @__PURE__ */ t("div", {
			className: "space-y-3",
			children: Array.from({ length: a }).map((e, n) => /* @__PURE__ */ t(qt, {
				className: "h-32 w-full",
				radius: Wt.XL
			}, `dashboard-record-skeleton-${n}`))
		}) : r.length === 0 ? /* @__PURE__ */ t(jt, {
			title: o,
			description: s,
			actionLabel: c,
			actionHref: l,
			...
			className: "space-y-3",
			children: r.map((n, r) => /* @__PURE__ */ t(Ut, { ...n }, n.id ?? n.key ?? `${e}-${r}`))
		})
	});
}
//#endregion
//#region src/components/DashboardProgressCard/DashboardProgressCard.jsx
var Yt = Object.freeze({
	CHECKLIST: "checklist",
	STEPS: "steps"
});
function Xt(e, t) {
	return e[t]?.done ? "complete" : t === e.findIndex((e) => !e.done) ? "current" : "upcoming";
}
function Zt(e) {
	return e === "complete" ? b.PRIMARY : e === "current" ? b.OUTLINE : b.SECONDARY;
}
function Qt({ className: e = "", ...n }) {
	return /* @__PURE__ */ t("svg", {
		viewBox: "0 0 24 24",
		fill: "none",
		stroke: "currentColor",
...
function $t({ checklist: e }) {
	return /* @__PURE__ */ t("div", {
		...
		children: /* @__PURE__ */ t("ol", {
			...
			children: e.map((r, i) => {
				let a = Xt(e, i), o = i > 0 && a !== "upcoming", s = !!(r.href || r.onClick), c = a === "upcoming" || !s, l = a === "complete" ? Qt : function() {
					return /* @__PURE__ */ t("span", { children: i + 1 });
				};
				return /* @__PURE__ */ n("li", {
					className: "relative grid min-w-0 flex-1 justify-items-center",
					children: [
						i > 0 ? /* @__PURE__ */ t("div", {
							className: `absolute right-1/2 top-5 h-1 w-full ${o ? "bg-[var(--fhl-color-accent)]" : "bg-[var(--fhl-color-border)]"}`,
							"aria-hidden": "true"
						}) : null,
						/* @__PURE__ */ t("div", {
							className: "relative z-10",
							children: /* @__PURE__ */ t(k, {
								href: c ? void 0 : r.href,
								onClick: c ? void 0 : r.onClick,
								disabled: c,
								variant: Zt(a),
								size: x.SM,
								shape: S.CIRCLE,
						...
						/* @__PURE__ */ t("div", {
							...
							children: /* @__PURE__ */ t(y, {
								as: "p",
								size: d.XS,
								tone: a === "current" ? p.ACCENT : a === "upcoming" ? p.MUTED : p.DEFAULT,
								weight: a === "current" ? f.BOLD : f.MEDIUM,
								align: "center",
								children: r.label
							})
						})
...
function en({ title: e = "Progress", description: r = "", percent: i = 0, summary: a = "", checklist: o = [], actionLabel: s = "", actionHref: c, onActionClick: l, layout: u = Yt.CHECKLIST }) {
	if (u === Yt.STEPS) return /* @__PURE__ */ t(H, {
		title: e,
		description: r,
		padding: z.SM,
		radius: V.XL,
		surface: B.DEFAULT,
		children: /* @__PURE__ */ t($t, { checklist: o })
	});
	let m = Math.max(0, Math.min(Number(i) || 0, 100));
	return /* @__PURE__ */ n(H, {
		title: e,
		description: r,
		headerAction: s ? /* @__PURE__ */ t(k, {
			href: c,
			onClick: l,
			variant: b.OUTLINE,
			size: x.SM,
		...
		children: [/* @__PURE__ */ n("div", { children: [
			...
			/* @__PURE__ */ t("div", {
				className: "mt-2 h-3 overflow-hidden rounded-full bg-[var(--fhl-color-surface-soft)]",
				children: /* @__PURE__ */ t("div", {
			...
			children: o.map((e, r) => /* @__PURE__ */ n("div", {
				className: "flex items-center gap-3 rounded-2xl bg-[var(--fhl-color-surface-soft)] px-4 py-3",
				children: [/* @__PURE__ */ t("div", {
					className: ["grid h-9 w-9 shrink-0 place-items-center rounded-full border", e.done ? "border-[var(--fhl-color-success-border)] bg-[var(--fhl-color-success-soft)] text-[var(--fhl-color-success)]" : "border-[var(--fhl-color-border)] bg-[var(--fhl-color-surface)] text-[var(--fhl-color-primary)]"].join(" "),
					children: e.done ? /* @__PURE__ */ t("svg", {
						viewBox: "0 0 24 24",
						fill: "none",
						stroke: "currentColor",
						className: "h-5 w-5",
					...
					}) : /* @__PURE__ */ t("span", { className: "h-2.5 w-2.5 rounded-full bg-current" })
				}), /* @__PURE__ */ t(y, {
					as: "p",
					size: d.SM,
					weight: f.SEMIBOLD,
...
var tn = "hidden min-h-0 flex-col md:!flex md:h-full md:border-b-0", Y = "duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]";
function nn(e) {
	return /* @__PURE__ */ t("svg", {
		viewBox: "0 0 24 24",
		fill: "none",
...
function sn(e) {
	return e ? `pointer-events-none max-w-0 -translate-x-1 overflow-hidden whitespace-nowrap opacity-0 transition-[max-width,opacity,transform] ${Y}` : `max-w-[160px] translate-x-0 overflow-hidden whitespace-nowrap opacity-100 transition-[max-width,opacity,transform] ${Y}`;
}
function cn(e) {
	return e ? "justify-center gap-0 px-2.5" : "justify-start gap-2 px-3";
}
function ln(e) {
	return e ? e.content ? e.content : /* @__PURE__ */ t(de, {
		mode: e.logoMode ?? U.HORIZONTAL,
		darkMode: e.darkLogoMode ?? U.DARK,
...
function dn({ isOpen: e, title: r, message: i, confirmLabel: o, cancelLabel: s, isConfirming: c = !1, onCancel: l, onConfirm: u }) {
	return a(() => {
		if (!e) return;
		function t(e) {
			e.key === "Escape" && l?.();
		...
		children: /* @__PURE__ */ n("div", {
			...
			children: [/* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ n("div", {
					...
					children: /* @__PURE__ */ t(rn, { className: "h-5 w-5" })
				})]
			}), /* @__PURE__ */ n("div", {
...
function pn({ item: r, collapsed: i = !1 }) {
	let a = r.icon, o = cn(i), s = r.isActive ? `flex items-center rounded-xl py-2 text-sm font-semibold transition-[background-color,color] ${Y} ${o} ${i ? "text-center" : ""}` : `flex items-center rounded-xl py-2 text-sm font-semibold transition-[background-color,color] hover:bg-[var(--fhl-navbar-hover-bg)] hover:text-[var(--fhl-navbar-text)] ${Y} ${o} ${i ? "text-center" : ""}`, c = r.isActive ? {
		backgroundColor: "var(--fhl-navbar-active-bg)",
		color: "var(--fhl-navbar-active-text)"
	} : { color: "var(--fhl-navbar-text-muted)" }, l = sn(i), u = Array.isArray(r.children) && r.children.length > 0 && r.showChildren && !i, d = /* @__PURE__ */ n(e, { children: [a ? /* @__PURE__ */ t(a, {
	...
	return /* @__PURE__ */ n("div", {
		...
		children: [r.href ? /* @__PURE__ */ t("a", {
			...
			children: r.children.map((e, n) => /* @__PURE__ */ t(fn, { item: e }, an(e, n)))
		}) : null]
	});
}
function mn({ item: r, collapsed: i = !1 }) {
	let a = r.icon, o = sn(i), s = cn(i), c = /* @__PURE__ */ n(e, { children: [a ? /* @__PURE__ */ t(a, {
		className: "h-5 w-5 shrink-0",
		"aria-hidden": "true",
		focusable: "false"
	}) : null, /* @__PURE__ */ t("span", {
	...
	return r.href ? /* @__PURE__ */ t("a", {
		href: r.href,
		onClick: r.onClick,
		className: `flex items-center rounded-xl py-2 text-sm font-semibold transition-[background-color,color] hover:bg-[var(--fhl-navbar-hover-bg)] ${Y} ${s} ${i ? "text-center" : ""}`,
		...
		type: "button",
		onClick: r.onClick,
		className: `flex w-full items-center rounded-xl py-2 text-left text-sm font-semibold transition-[background-color,color] hover:bg-[var(--fhl-navbar-hover-bg)] ${Y} ${s} ${i ? "text-center" : ""}`,
		style: { color: "var(--fhl-navbar-text-muted)" },
		title: i ? r.label : void 0,
		children: c
	});
}
function hn({ brand: r, navItems: i = [], navSections: o = [], footerItems: s = [], className: l = "", style: d, collapsed: f = !1, collapseToggle: p, isSigningOut: m = !1, onSignOut: h, signOutIcon: g, signOutLabel: _ = "Log out", signingOutLabel: v = "Signing out...", supportItem: y, supportLabel: b = "Call support", supportHref: x = "tel:+13055550199", supportIcon: S = nn, requireSignOutConfirmation: C = !0, signOutConfirmationTitle: w = "Sign out?", signOutConfirmationMessage: T = "You will need to sign in again to access this dashboard.", signOutConfirmationLabel: E = "Sign out", signOutCancelLabel: D = "Cancel", mobileDrawer: O = !1, mobileOpen: k = !1, onMobileClose: A, mobileWidthClassName: j = "!w-[50vw] max-w-[50vw]", mobileCloseLabel: M = "Close menu", mobileCloseIcon: N = rn }) {
	let [P, F] = u(!1), [I, ee] = u(un), L = O && k && !I, R = L ? !1 : f, te = O ? [
		tn,
		L ? "!fixed inset-y-0 left-0 z-[70] !flex h-[100dvh]" : "",
		"md:!relative md:inset-auto md:z-auto md:!flex md:h-full md:border-b-0",
		l,
		L ? j : ""
	].filter(Boolean).join(" ").trim() : `${tn} ${l}`.trim(), z = ln(r), B = c(() => {
		if (y === !1 || y === null) return null;
		let e = typeof y == "object" && y ? y : {
			href: x,
			label: b
		};
		return {
		...
		y,
		b
	]), V = !!B || s.length > 0 || h, ne = Array.isArray(o) && o.length > 0 ? o : [{ items: i }];
	a(() => {
		if (typeof window > "u" || typeof window.matchMedia != "function") return;
		let e = window.matchMedia("(min-width: 768px)"), t = (e) => {
			ee(e.matches);
		};
		return ee(e.matches), typeof e.addEventListener == "function" ? (e.addEventListener("change", t), () => {
	...
	async function ie() {
		!h || m || (F(!1), await Promise.resolve(h()));
	}
	return /* @__PURE__ */ n(e, { children: [
		...
		/* @__PURE__ */ n("aside", {
			...
			children: [
				p?.onToggle || L ? /* @__PURE__ */ n("div", {
					className: `flex h-20 border-b px-2 py-2 transition-[justify-content,padding] ${Y} ${R ? "justify-center" : "items-center justify-between"}`,
					...
					children: [
						z ? /* @__PURE__ */ t("a", {
							...
							className: `inline-flex items-center overflow-hidden rounded-md p-1 transition-[max-width,opacity,transform] ${Y} ${R ? "pointer-events-none max-w-0 -translate-x-2 opacity-0" : "max-w-[11rem] translate-x-0 opacity-100"}`,
							children: z
						}) : null,
						L ? /* @__PURE__ */ t("button", {
							type: "button",
						...
						p?.onToggle && I ? /* @__PURE__ */ t("button", {
							type: "button",
							onClick: p.onToggle,
							className: `inline-flex rounded-md p-1.5 transition hover:bg-[var(--fhl-navbar-hover-bg)] ${Y}`,
							style: {
								backgroundColor: "var(--fhl-navbar-surface-soft)",
								color: "var(--fhl-navbar-text)"
							},
							"aria-label": R ? p.collapsedLabel ?? "Expand menu" : p.expandedLabel ?? "Collapse menu",
							title: R ? p.collapsedLabel ?? "Expand menu" : p.expandedLabel ?? "Collapse menu",
							children: R ? p.collapsedIcon : p.expandedIcon
						}) : null
					]
				}) : z ? /* @__PURE__ */ t("div", {
				...
				V ? /* @__PURE__ */ n("div", {
					...
					children: [
						...
						h ? /* @__PURE__ */ n("button", {
							...
							onClick: re,
							disabled: m,
							className: `flex w-full items-center rounded-xl py-2 text-left text-sm font-semibold transition-[background-color,color] hover:bg-[var(--fhl-navbar-hover-bg)] disabled:opacity-60 ${Y} ${cn(R)}`,
							style: { color: "var(--fhl-navbar-text-muted)" },
							"aria-label": m ? v : _,
							title: R ? _ : void 0,
...
function bn({ breadcrumbItems: e = [], actions: r = [], className: i = "", style: a }) {
	return /* @__PURE__ */ t("section", {
		...
		children: /* @__PURE__ */ n("div", {
			...
			children: [/* @__PURE__ */ t(It, { items: e }), r.length > 0 ? /* @__PURE__ */ t("div", {
				className: "flex flex-wrap items-center gap-2",
				children: r.map((e, n) => /* @__PURE__ */ t(yn, { action: e }, gn(e, n)))
			}) : null]
		})
	});
}
...
function wn({ dashboardLabel: e = "Dashboard", currentTabLabel: r = "Overview", currentTabHint: i = "", displayName: o = "User", userLabel: s = "Logged user", topbarBadges: c = [], avatarContent: l, mobileMenuButton: d, className: f = "", style: p }) {
	let [m, h] = u(Cn), g = String(o || "User").trim() || "User", _ = l ?? g.charAt(0).toUpperCase(), v = `px-4 py-3 md:px-5 ${f}`.trim(), y = d?.icon ?? Sn, b = d?.label ?? "Open menu";
	return a(() => {
		if (typeof window > "u" || typeof window.matchMedia != "function") return;
		let e = window.matchMedia("(min-width: 768px)"), t = (e) => {
			h(e.matches);
...
function An({ columns: e = [], rows: r = [], rowKey: i = "id", selectedRowKey: a, onRowClick: o, emptyMessage: s = "No records available.", className: c = "", tableClassName: l = "" }) {
	let u = Array.isArray(r) && r.length > 0;
	return /* @__PURE__ */ t("div", {
		className: Tn("overflow-hidden rounded-2xl border bg-[var(--fhl-color-surface)] shadow-[0_18px_40px_-30px_var(--fhl-color-shadow)]", c),
		style: { borderColor: "var(--fhl-color-border)" },
		children: /* @__PURE__ */ t("div", {
			className: "overflow-x-auto",
			children: /* @__PURE__ */ n("table", {
				className: Tn("min-w-full border-collapse", l),
				children: [/* @__PURE__ */ t("thead", {
					className: "bg-[var(--fhl-color-surface-soft)]",
					children: /* @__PURE__ */ t("tr", { children: e.map((e, n) => /* @__PURE__ */ t("th", {
						scope: "col",
						className: Tn("px-4 py-3 text-xs font-bold uppercase tracking-[0.14em] text-[var(--fhl-color-text-muted)]", On(e.align), e.headerClassName),
						style: e.width ? { width: e.width } : void 0,
						children: e.label
					}, En(e, n))) })
				}), /* @__PURE__ */ t("tbody", { children: u ? r.map((n, r) => {
					let s = Dn(n, r, i), c = a === s, l = typeof o == "function";
					return /* @__PURE__ */ t("tr", {
						className: Tn("border-t transition", l ? "cursor-pointer hover:bg-[color-mix(in_srgb,var(--fhl-color-surface)_90%,var(--fhl-color-primary)_10%)]" : "", c ? "bg-[color-mix(in_srgb,var(--fhl-color-surface)_88%,var(--fhl-color-primary)_12%)]" : ""),
						style: { borderColor: "var(--fhl-color-border)" },
						...
						children: e.map((e, r) => /* @__PURE__ */ t("td", {
							className: Tn("px-4 py-3 align-top text-sm text-[var(--fhl-color-text)]", On(e.align), e.cellClassName),
...
function jn({ items: e = [], className: r = "" }) {
...
function In({ isOpen: e, position: r, items: i = [], sections: o = [], onClose: d }) {
	let f = l(null), [p, m] = u(Mn), h = c(() => {
	...
	s(() => {
		...
		let t = f.current.getBoundingClientRect(), n = t.width || Mn.width, r = t.height || Mn.height;
...
function Bn(e, n) {
	return /* @__PURE__ */ t("span", {
		...
		style: Rn[e?.tone] || Rn.default,
		children: e?.label
	}, e?.key || `${e?.label || "badge"}-${n}`);
}
function Vn({ imageUrl: e = "", imageAlt: r = "", imageFallbackLabel: i = "No image", eyebrow: a = "", title: o, subtitle: s = "", description: c = "", meta: l = [], badges: u = [], onClick: d, onContextMenu: f, onActionsClick: p, actionsLabel: m = "Actions", actionIcon: h, className: g = "" }) {
	return /* @__PURE__ */ t("article", {
		className: Ln("group min-w-0 rounded-xl border p-3.5 transition md:p-4", "hover:border-[var(--fhl-color-primary)] hover:bg-[color-mix(in_srgb,var(--fhl-color-surface)_92%,var(--fhl-color-primary)_8%)]", g),
		style: {
			borderColor: "var(--fhl-color-border)",
			backgroundColor: "var(--fhl-color-surface)",
...
function ir({ isFavorite: e = !1, isSaving: r = !1, onToggle: i, variant: a = "floating", className: o = "", label: s, title: c }) {
	...
	return /* @__PURE__ */ n("button", {
		...
		"aria-label": u,
		title: c || u,
		children: [e ? /* @__PURE__ */ t(Hn, { className: l ? "h-5 w-5" : "h-7 w-7" }) : /* @__PURE__ */ t(er, { className: l ? "h-5 w-5 stroke-[2.2]" : "h-7 w-7 stroke-[2.2]" }), l ? /* @__PURE__ */ t("span", { children: e ? "Saved" : "Save" }) : null]
	});
}
//#endregion
...
var ur = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, selected: c = !1, files: u = [], accept: m = "", multiple: h = !1, required: g = !1, disabled: _ = !1, buttonLabel: v = "", emptyTitle: S = "", emptyDescription: C = "", onFilesSelect: w, onRemoveFile: T, className: E = "", dropzoneClassName: D = "", fileListClassName: O = "" }, A) {
	let j = o(), M = e ?? `fhl-file-uploader-${j}`, N = l(null), P = lr(u), F = P.length > 0, I = cr(a, c || F), ee = {
	...
	return /* @__PURE__ */ n("div", {
		className: sr("w-full space-y-3", E),
		children: [
			r ? /* @__PURE__ */ n(y, {
				as: "label",
				htmlFor: M,
			...
			/* @__PURE__ */ n("div", {
				className: sr("rounded-[28px] border border-dashed bg-[var(--fhl-container-bg-soft)] p-4 transition", "border-[var(--fhl-file-uploader-current-border)] focus-within:ring-4", _ ? "opacity-60" : "", D),
				style: ee,
				children: [/* @__PURE__ */ n("div", {
					...
					className: sr("mt-4 space-y-2 border-t border-[var(--fhl-container-border)] pt-4", O),
					children: P.map((e, r) => {
...
var gr = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, icon: c, selected: l = !1, className: u = "", containerClassName: m = "", selectClassName: h = "", labelClassName: g = "", helperClassName: _ = "", statusClassName: v = "", disabled: b = !1, required: x = !1, children: S, "aria-describedby": C, "aria-invalid": w, ...T }, E) {
	let D = o(), O = e ?? `fhl-select-${D}`, k = i ? `${O}-helper` : void 0, A = s ? `${O}-status` : void 0, j = mr(C, k, A), M = w ?? (a === G.ERROR ? !0 : void 0), N = hr(a, l), P = {
	...
	return /* @__PURE__ */ n("div", {
		className: pr("w-full space-y-1.5", u),
		children: [
			r ? /* @__PURE__ */ n(y, {
				as: "label",
				htmlFor: O,
				size: d.SM,
				weight: f.SEMIBOLD,
				className: pr("block text-[var(--fhl-input-label)]", g),
			...
			/* @__PURE__ */ n("div", {
				...
				children: [
					...
					/* @__PURE__ */ t("select", {
						...
						"aria-describedby": j,
						"aria-invalid": M,
						className: pr("min-w-0 flex-1 appearance-none bg-transparent text-[length:var(--fhl-text-size-sm)] leading-[var(--fhl-text-leading-sm)] font-medium text-[var(--fhl-input-text)] outline-none", "disabled:cursor-not-allowed disabled:text-[var(--fhl-input-disabled-text)]", h),
						children: S
					}),
					/* @__PURE__ */ t(Ue, {
			...
			i ? /* @__PURE__ */ t(y, {
				...
				weight: f.MEDIUM,
				tone: p.MUTED,
				className: pr("text-[var(--fhl-input-helper)]", _),
				children: i
			}) : null,
			s ? /* @__PURE__ */ t(y, {
				as: "p",
...
var X = "flex flex-col gap-1.5", Z = "text-xs font-semibold tracking-wide uppercase text-[var(--fhl-color-text-muted)]", Q = "min-h-10 rounded-xl border-[var(--fhl-color-border)] px-3 py-2 shadow-none", $ = "text-sm", yr = "h-8 px-3 shadow-none transition-colors duration-200";
function br({ filters: e, propertyTypeOptions: r = [], onFilterChange: i, onClearFilters: o }) {
		...
		children: [/* @__PURE__ */ n("div", {
			...
			children: [
				/* @__PURE__ */ t(K, {
					...
					className: `${X} col-span-2 min-w-0 md:col-span-1`,
					labelClassName: Z,
			...
			children: [/* @__PURE__ */ n("div", {
				...
				children: [/* @__PURE__ */ n("div", {
					...
					children: [/* @__PURE__ */ t(k, {
						...
						size: x.SM,
						shape: S.PILL,
						className: `${yr} inline-flex border-transparent bg-(--fhl-color-hover-soft) text-(--fhl-color-text) hover:bg-(--fhl-color-selected-soft)`,
					...
					size: x.SM,
					shape: S.PILL,
					className: `${yr} border-transparent bg-(--fhl-color-accent)  text-(--fhl-color-accent-contrast) hover:bg-(--fhl-color-accent) hover:brightness-95`,
					children: "Clear"
				})]
			}), /* @__PURE__ */ t("div", {
				...
				children: /* @__PURE__ */ n("div", {
					...
					children: [
						...
						/* @__PURE__ */ t(gr, {
							...
							containerClassName: Q,
							selectClassName: $,
							children: _r.map((e) => /* @__PURE__ */ t("option", {
								value: e.value,
								children: e.label
							}, e.value))
						}),
...
var xr = "image/webp,image/jpeg,image/png";
function Sr(e) {
	if (!e) return "";
	let t = e / (1024 * 1024);
	return `${Number.isInteger(t) ? t : t.toFixed(1)}MB`;
}
function Cr(e, { accept: t, maxSizeBytes: n }) {
	let r = t ? t.split(",").map((e) => e.trim()) : null;
	return r && r.length > 0 && !r.includes(e.type) ? "Use a valid image format." : n && e.size > n ? `Each image must be ${Sr(n)} or less.` : null;
}
function wr(e, t) {
	return [
		e?.name,
...
function Dr(e, t) {
	if (!e) return null;
	if (Tr(e)) return typeof URL > "u" || typeof URL.createObjectURL != "function" ? null : {
		key: wr(e, t),
		label: Er(e, t),
...
function Or({ disabled: e, multiple: r, onClick: i }) {
	return /* @__PURE__ */ n("button", {
		type: "button",
		onClick: i,
		disabled: e,
		...
		children: [
			/* @__PURE__ */ n("span", {
				...
				children: [/* @__PURE__ */ t(Yn, { className: "h-6 w-6 opacity-80" }), /* @__PURE__ */ t("span", {
					...
					children: /* @__PURE__ */ t(Jn, { className: "h-4 w-4" })
				})]
			}),
			/* @__PURE__ */ t("span", {
...
function kr({ preview: e, label: r, removable: i = !0, onOpenPicker: a, onRemove: o }) {
	return /* @__PURE__ */ n("div", {
...
function Ar({ label: e, helperText: r, multiple: i = !1, maxFiles: s, accept: c = xr, maxSizeBytes: d, value: f, onChange: p, onError: m, required: h = !1 }) {
	let g = o(), _ = l(null), [v, y] = u([]), b = i ? Array.isArray(f) ? f : [] : f ? [f] : [], x = !!(i && s && b.length >= s);
	a(() => {
		let e = (i ? Array.isArray(f) ? f : [] : f ? [f] : []).map((e, t) => Dr(e, t)).filter(Boolean);
		return y(e), () => {
			e.forEach((e) => {
	...
	return /* @__PURE__ */ n("div", {
		...
		children: [
			...
			/* @__PURE__ */ n("div", {
				...
				}), i ? x ? null : /* @__PURE__ */ t(Or, {
					disabled: !1,
					multiple: !0,
					onClick: S
				}) : b.length > 0 ? null : /* @__PURE__ */ t(Or, {
					disabled: !1,
					multiple: !1,
					onClick: S
				})]
...
function jr({ label: e, value: r, hint: i, icon: a }) {
	return /* @__PURE__ */ n("article", {
...
function Ir({ isOpen: r, title: i = "Photos", images: o = [], initialIndex: s = 0, onClose: l }) {
	let [d, f] = u(() => Fr(o, s));
	a(() => {
		r && f(Fr(o, s));
	}, [
			...
			children: [
				/* @__PURE__ */ n("div", {
					...
					children: [/* @__PURE__ */ n("div", { children: [/* @__PURE__ */ t("p", {
						...
						children: /* @__PURE__ */ t(Mr, { className: "h-5 w-5" })
					})]
				}),
				/* @__PURE__ */ n("div", {
					...
					children: [/* @__PURE__ */ t("img", {
						...
						children: /* @__PURE__ */ t(Pr, { className: "h-5 w-5" })
					})] }) : null]
				}),
...
function Lr({ label: e = "No photos available" }) {
	return /* @__PURE__ */ t("div", {
...
function Rr({ images: r = [], selectedIndex: i = 0, onSelectIndex: a, badge: o, altText: s = "Photo", emptyLabel: c = "No photos available", maxThumbs: l = 5, onImageClick: u, heightClassName: d = "h-[28rem]" }) {
...
function Wr({ title: e, propertyType: r, address: i, coverImageUrl: a, coverImageAlt: o, onOpen: s, onEdit: c, editIcon: l, editLabel: u = "Edit property", imageFallbackLabel: m = "No cover image", availableUnitsLabel: h, occupancyLabel: g, occupancyTone: _ = zr.DEFAULT, ratingValue: v = null, ratingCount: b = 0, className: x = "" }) {
	let S = Number.isFinite(Number(v)) && Number(b) > 0, C = Br[_] ?? Br[zr.DEFAULT], w = b === 1 ? "1 review" : `${b} reviews`;
	return /* @__PURE__ */ n("article", {
		className: Vr("group relative overflow-hidden rounded-2xl border transition duration-200 hover:-translate-y-1 hover:shadow-[0_22px_40px_-26px_var(--fhl-color-shadow)]", x),
		style: {
			borderColor: "var(--fhl-color-border)",
			backgroundColor: "var(--fhl-color-surface)",
		...
		children: [/* @__PURE__ */ n("button", {
			...
			children: [/* @__PURE__ */ n("div", {
				...
				}) : /* @__PURE__ */ t(Ur, { label: m }), /* @__PURE__ */ t("div", { className: "pointer-events-none absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-black/55 via-black/10 to-transparent" })]
			}), /* @__PURE__ */ n("div", {
					...
					/* @__PURE__ */ n("div", {
						...
						children: [/* @__PURE__ */ n("div", {
							...
							children: [/* @__PURE__ */ t(y, {
								...
								children: [/* @__PURE__ */ t(Hr, { className: "h-4 w-4 text-[var(--fhl-color-primary)]" }), S ? /* @__PURE__ */ t(y, {
									as: "p",
									size: d.SM,
...
function Kr({ isOpen: e, title: r, description: i = "", label: o, value: s = "", fields: c = [], placeholder: l = "", type: p = "text", options: m = [], multiline: h = !1, isSubmitting: g = !1, errorMessage: _ = "", onClose: v, onSubmit: b }) {
...
function Zr({ icon: e, value: r, label: i, size: a = qr.MD, align: o = "center", className: s = "" }) {
	return /* @__PURE__ */ n("div", {
		className: Xr("flex items-center gap-3 px-2", o === "center" ? "justify-center" : "justify-start", s),
		children: [e ? /* @__PURE__ */ t(e, {
			className: Xr(Jr[a] ?? Jr.md, "shrink-0 text-[var(--fhl-color-primary)]"),
			"aria-hidden": "true",
			focusable: "false"
		}) : null, /* @__PURE__ */ n("div", {
			className: "text-left",
...
function $r({ items: e = [], activeKey: n, onSelect: r, className: i = "" }) {
	return /* @__PURE__ */ t("nav", {
		className: Qr("flex gap-8 overflow-x-auto border-b text-sm font-semibold text-[var(--fhl-color-text-muted)]", i),
		style: { borderColor: "var(--fhl-color-border)" },
		children: e.map((e) => {
			let i = e.key === n;
			return /* @__PURE__ */ t("a", {
				href: e.href,
				onClick: (t) => r?.(e.key, t),
				className: Qr("shrink-0 border-b-2 px-1 py-4 transition hover:text-[var(--fhl-color-accent)]", i ? "border-[var(--fhl-color-accent)] text-[var(--fhl-color-accent)]" : "border-transparent"),
				children: e.label
			}, e.key);
		})
	});
...
var ai = i(function({ id: e, label: r, helperText: i, status: a, statusMessage: s, icon: c, selected: l = !1, className: u = "", containerClassName: m = "", textareaClassName: h = "", labelClassName: g = "", helperClassName: _ = "", statusClassName: v = "", disabled: b = !1, required: x = !1, rows: S = 4, resize: C = "vertical", "aria-describedby": w, "aria-invalid": T, ...E }, D) {
	let O = o(), k = e ?? `fhl-textarea-${O}`, A = i ? `${k}-helper` : void 0, j = s ? `${k}-status` : void 0, M = ri(w, A, j), N = T ?? (a === G.ERROR ? !0 : void 0), P = ii(a, l), F = {
	...
	return /* @__PURE__ */ n("div", {
		className: ni("w-full space-y-1.5", u),
		children: [
			r ? /* @__PURE__ */ n(y, {
				as: "label",
				htmlFor: k,
				size: d.SM,
				weight: f.SEMIBOLD,
				className: ni("block text-[var(--fhl-input-label)]", g),
				children: [r, x ? /* @__PURE__ */ t("span", {
					className: "ml-1 text-[var(--fhl-color-primary)]",
					children: "*"
				}) : null]
			...
			/* @__PURE__ */ n("div", {
				className: ni("flex gap-3 rounded-2xl border px-3.5 py-3 shadow-sm transition", "border-[var(--fhl-textarea-current-border)] bg-[var(--fhl-textarea-current-bg)]", "focus-within:border-[var(--fhl-textarea-current-border)]", "focus-within:ring-4 focus-within:ring-[var(--fhl-textarea-current-ring)]", b ? "cursor-not-allowed" : "", m),
				style: F,
			...
			i ? /* @__PURE__ */ t(y, {
				...
				weight: f.MEDIUM,
				tone: p.MUTED,
				className: ni("text-[var(--fhl-input-helper)]", _),
				children: i
			}) : null,
			s ? /* @__PURE__ */ t(y, {
				as: "p",
...
function li(e) {
	return e === oi.DARK ? Pe : e === oi.LIGHT ? je : Fe;
}
function ui(e) {
	return e === "navy" ? {
...
function di({ value: e = oi.SYSTEM, onChange: r, options: i = si, compact: a = !1, tone: o = "surface", className: s = "", ariaLabel: c = "Theme mode", disabled: l = !1 }) {
	return /* @__PURE__ */ t("div", {
		role: "radiogroup",
		"aria-label": c,
		className: ci("inline-flex items-center rounded-full border transition", a ? "gap-1 px-1.5 py-2" : "gap-1 px-1.5 py-1.5", s),
		style: ui(o),
		children: i.map((i) => {
			let o = e === i.mode, s = li(i.mode);
			return /* @__PURE__ */ n("button", {
				type: "button",
				role: "radio",
				"aria-checked": o,
				...
				disabled: l,
				onClick: () => r?.(i.mode),
				className: ci("inline-flex items-center justify-center rounded-full transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--fhl-color-accent-hover) focus-visible:ring-offset-2 focus-visible:ring-offset-(--fhl-color-bg) disabled:cursor-not-allowed disabled:opacity-60", a ? "h-7 w-7" : "gap-1.5 px-2.5 py-1.5", o ? "bg-(--fhl-color-accent) text-(--fhl-color-accent-contrast)" : "text-(--fhl-color-text-muted) hover:bg-(--fhl-color-hover-soft) hover:text-(--fhl-color-text)"),
				children: [/* @__PURE__ */ t(s, {
					"aria-hidden": "true",
					className: ci(a ? "h-3.5 w-3.5" : "h-4 w-4", o ? "opacity-100" : "opacity-80")
				}), a ? null : /* @__PURE__ */ t(y, {
					as: "span",
					size: d.XS,
					weight: f.SEMIBOLD,
...
var fi = new Intl.NumberFormat("en-US", {
	style: "currency",
	currency: "USD",
	maximumFractionDigits: 0
}), pi = new Intl.NumberFormat("en-US", { maximumFractionDigits: 0 });
function mi(e) {
	if (e == null || e === "") return "—";
	let t = Number(e);
	return Number.isFinite(t) ? pi.format(t) : "—";
}
function hi(e) {
	let t = String(e || "").trim();
...
function _i(e) {
	...
	return [[t, n].filter(Boolean).join(", "), r].filter(Boolean).join(" ") || gi(e);
}
function vi({ listing: e, onNavigate: r, isFavorite: i = !1, isFavoriteSaving: a = !1, onToggleFavorite: o }) {
	let s = Number(e.rentAmount), c = Number.isFinite(s), l = hi(e.property.propertyType), u = Number(e.parkingSpaces), m = Number.isFinite(u) && u > 0;
	return /* @__PURE__ */ n("article", {
			...
			children: [/* @__PURE__ */ t("div", {
				...
				children: [
					...
					/* @__PURE__ */ n("div", {
						...
						children: [/* @__PURE__ */ n("div", {
							...
							children: [/* @__PURE__ */ t(y, {
								...
								children: [/* @__PURE__ */ t(Zn, { className: "h-4 w-4 shrink-0 text-[var(--fhl-color-primary)]" }), /* @__PURE__ */ t(y, {
									as: "span",
									size: d.XS,
									tone: p.MUTED,
									weight: f.MEDIUM,
									truncate: !0,
									children: _i(e.property)
								})]
							})]
						}), /* @__PURE__ */ n(y, {
							as: "p",
							...
							children: [c ? fi.format(s) : "Price", /* @__PURE__ */ t(y, {
								as: "span",
								size: d.XS,
								tone: p.MUTED,
								weight: f.SEMIBOLD,
					...
					/* @__PURE__ */ n("div", {
						...
						children: [
							/* @__PURE__ */ n("div", {
								...
								children: [/* @__PURE__ */ t($n, { className: "h-5 w-5 text-[var(--fhl-color-primary)]" }), /* @__PURE__ */ n("div", {
									className: "text-left",
									children: [/* @__PURE__ */ t(y, {
										as: "p",
										size: d.SM,
										weight: f.BOLD,
										children: mi(e.bedrooms)
									}), /* @__PURE__ */ t(y, {
										as: "p",
										size: d.XS,
										tone: p.MUTED,
							...
							/* @__PURE__ */ n("div", {
								className: "flex items-center justify-center gap-2 px-1",
								children: [/* @__PURE__ */ t(tr, { className: "h-5 w-5 text-[var(--fhl-color-primary)]" }), /* @__PURE__ */ n("div", {
									className: "text-left",
									children: [/* @__PURE__ */ t(y, {
										as: "p",
										size: d.SM,
										weight: f.BOLD,
										children: mi(e.bathrooms)
									}), /* @__PURE__ */ t(y, {
										as: "p",
										size: d.XS,
										tone: p.MUTED,
							...
							/* @__PURE__ */ n("div", {
								className: "flex items-center justify-center gap-2 px-1",
								children: [/* @__PURE__ */ t(nr, { className: "h-5 w-5 text-[var(--fhl-color-primary)]" }), /* @__PURE__ */ n("div", {
									className: "text-left",
									children: [/* @__PURE__ */ t(y, {
										as: "p",
										size: d.SM,
										weight: f.BOLD,
										children: mi(e.squareFeet)
									}), /* @__PURE__ */ t(y, {
										as: "p",
										size: d.XS,
										tone: p.MUTED,
					...
					/* @__PURE__ */ n("div", {
						...
						children: [
							/* @__PURE__ */ n(y, {
								...
								children: [/* @__PURE__ */ t(Kn, { className: "h-3.5 w-3.5 text-[var(--fhl-color-primary)]" }), m ? `${mi(e.parkingSpaces)} parking` : "No parking"]
							}),
							/* @__PURE__ */ n(y, {
								as: "span",
								size: d.XS,
								...
								className: "inline-flex items-center gap-1.5 rounded-full bg-[var(--fhl-color-surface-soft)] px-3 py-1.5 text-[11px]",
								children: [
									/* @__PURE__ */ t(qn, { className: "h-3.5 w-3.5 text-[var(--fhl-color-primary)]" }),
									"Pets ",
					...
					/* @__PURE__ */ n(y, {
						...
						children: ["View details", /* @__PURE__ */ t(rr, { className: "h-4 w-4 transition group-hover:translate-x-1" })]
					})
				]
			})]
		}), /* @__PURE__ */ t(ir, {
...
//#endregion
export { J as AUTH_PORTAL_MODE, kt as AuthPortalPage, pe as AuthRedirectCard, j as BADGE_SIZE, A as BADGE_TONE, S as BUTTON_SHAPE, x as BUTTON_SIZE, b as BUTTON_VARIANT, L as Badge, k as Button, Ge as CHECKBOX_STATUS, z as CONTAINER_PADDING, V as CONTAINER_RADIUS, B as CONTAINER_SURFACE, Lt as Card, Ze as Checkbox, H as Container, Yt as DASHBOARD_PROGRESS_CARD_LAYOUT, Rt as DASHBOARD_RECORD_CARD_TONE, Nt as DashboardActivityFeed, It as DashboardBreadcrumb, jt as DashboardEmptyState, hn as DashboardNavbar, en as DashboardProgressCard, Ut as DashboardRecordCard, Jt as DashboardRecordList, bn as DashboardRouteBar, wn as DashboardTopbar, An as DataTable, jn as DefinitionList, In as EntityActionMenu, Vn as EntityListItem, ar as FILE_UPLOADER_STATUS, ir as FavoriteButton, ur as FileUploader, br as HomeFilters, G as INPUT_STATUS, Ar as ImageUploader, K as Input, U as LOGO_MODES, de as Logo, jr as MetricCard, q as NOTICE_TONE, it as Notice, zr as PROPERTY_DASHBOARD_CARD_FEEDBACK_TONE, Ir as PhotoCarouselModal, Rr as PhotoGallery, Wr as PropertyDashboardCard, lt as PublicFooter, St as PublicNavbar, Kr as QuickEditFieldDialog, dr as SELECT_STATUS, Wt as SKELETON_RADIUS, qr as STAT_ITEM_SIZE, gr as Select, qt as Skeleton, Zr as StatItem, ei as TEXTAREA_STATUS, d as TEXT_SIZE, p as TEXT_TONE, f as TEXT_WEIGHT, oi as THEME_TOGGLE_MODE, $r as Tabs, y as Text, ai as Textarea, di as ThemeToggle, vi as UnitListingCard };
